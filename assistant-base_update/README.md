...
- **Расписание**: Каждый день в **08:02** (Europe/Moscow) — сдвиг от :00 и от слотов онлайн-синхронизации (мин. 1,4,7…). Окно данных по-прежнему **вчера 08:00 — сегодня 08:00**.
...
data-sync:
  enabled: true
  schedule: "0 1/3 * * * ?"  # Онлайн-синхр.; BD в коде: cron 0 2 8 * * * (08:02)
  sql_server:
...
Модуль автоматически запускает BD по расписанию (**08:02** каждый день, Москва).
