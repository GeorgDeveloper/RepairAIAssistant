...
/**
 * Сущность для таблицы production_metrics_online в MySQL.
 * 
 * Содержит онлайн метрики производства по областям:
 ...
 */
@Entity
@Table(name = "production_metrics_online")
public class ProductionMetricsOnline {
    ...
    // Конструкторы
    public ProductionMetricsOnline() {}

    public ProductionMetricsOnline(String area, Double machineDowntime, Double wtMin, 
