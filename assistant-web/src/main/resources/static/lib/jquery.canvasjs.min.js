...
/* 
 CanvasJS Chart - v3.14.4 GA - https://canvasjs.com/ 
...
n.length*this.lineHeight:this.height+f;this.height=Math.min(l,this.height);this.width=Math.min(d,this.width)}"top"===this.verticalAlign?(e="left"===this.horizontalAlign?g.x1:"right"===this.horizontalAlign?g.x2-this.width:g.x1+g.width/2-this.width/2,b=g.y1):"center"===this.verticalAlign?(e="left"===this.horizontalAlign?g.x1:"right"===this.horizontalAlign?g.x2-this.width:g.x1+g.width/2-this.width/2,b=g.y1+g.height/2-this.height/2):"bottom"===this.verticalAlign&&(e="left"===this.horizontalAlign?g.x1:
"right"===this.horizontalAlign?g.x2-this.width:g.x1+g.width/2-this.width/2,b=g.y2-this.height);this.items=h;for(p=0;p<this.items.length;p++)r=h[p],r.id=++this.chart._eventManager.lastObjectId,this.chart._eventManager.objectMap[r.id]={id:r.id,objectType:"legendItem",legendItemIndex:p,dataSeriesIndex:r.dataSeriesIndex,dataPointIndex:r.dataPointIndex};this.markerSize=s;this.rows=n;0<h.length&&a.layoutManager.registerSpace(c,{width:this.width+2+2,height:this.height+5+5});this.bounds={x1:e,y1:b,x2:e+this.width,
y2:b+this.height}};D.prototype.render=function(){var a=this.bounds.x1,g=this.bounds.y1,c=this.markerMargin,b=this.maxWidth,e=this.maxHeight,d=this.markerSize,l=this.rows;(0<this.borderThickness&&this.borderColor||this.backgroundColor)&&this.ctx.roundRect(a,g,this.width,this.height,this.cornerRadius,this.borderThickness,this.backgroundColor,this.borderColor);for(var k=0,m=0;m<l.length;m++){for(var n=l[m],p=0,h=0;h<n.items.length;h++){var r=n.items[h],f=r.textBlock.x+a+(0===h?0.2*d:this.horizontalSpacing),
u=g+k,s=f;this.chart.data[r.dataSeriesIndex].visible||(this.ctx.globalAlpha=0.5);this.ctx.save();this.ctx.beginPath();this.ctx.rect(a,g,b,Math.max(e-e%this.lineHeight,0));this.ctx.clip();if("line"===r.chartType||"stepLine"===r.chartType||"spline"===r.chartType)this.ctx.strokeStyle=r.lineColor,this.ctx.lineWidth=Math.ceil(this.lineHeight/8),this.ctx.beginPath(),this.ctx.moveTo(f-0.1*this.lineHeight,u+this.lineHeight/2),this.ctx.lineTo(f+0.85*this.lineHeight,u+this.lineHeight/2),this.ctx.stroke(),s-=
...
d/2,u+this.lineHeight/2,this.ctx,r.markerType,"error"===r.chartType||"line"===r.chartType||"spline"===r.chartType?r.markerSize/2:r.markerSize,r.markerColor,r.markerBorderColor,r.markerBorderThickness);r.textBlock.x=f+c+d;if("line"===r.chartType||"stepLine"===r.chartType||"spline"===r.chartType)r.textBlock.x+=0.1*this.lineHeight;r.textBlock.y=Math.round(u+this.lineHeight/2);r.textBlock.render(!0);this.ctx.restore();p=0<h?Math.max(p,r.textBlock.height?r.textBlock.height:this.lineHeight):r.textBlock.height?
r.textBlock.height:this.lineHeight;this.chart.data[r.dataSeriesIndex].visible||(this.ctx.globalAlpha=1);f=W(r.id);this.ghostCtx.fillStyle=f;this.ghostCtx.beginPath();this.ghostCtx.fillRect(s,r.textBlock.y-this.lineHeight/2,r.textBlock.x+r.textBlock.width-s,r.textBlock.height?r.textBlock.height:this.lineHeight);r.x1=this.chart._eventManager.objectMap[r.id].x1=s;r.y1=this.chart._eventManager.objectMap[r.id].y1=r.textBlock.y-this.lineHeight/2;r.x2=this.chart._eventManager.objectMap[r.id].x2=r.textBlock.x+
r.textBlock.width;r.y2=this.chart._eventManager.objectMap[r.id].y2=r.textBlock.y+(r.textBlock.height?r.textBlock.height:this.lineHeight)-this.lineHeight/2}k+=p}};ra(T,S);T.prototype.getDefaultAxisPlacement=function(){var a=this.type;if("column"===a||"line"===a||"stepLine"===a||"spline"===a||"area"===a||"stepArea"===a||"splineArea"===a||"stackedColumn"===a||"stackedLine"===a||"bubble"===a||"scatter"===a||"stackedArea"===a||"stackedColumn100"===a||"stackedLine100"===a||"stackedArea100"===a||"candlestick"===
...
a);return null};T.prototype.getDataPointAtX=function(a,g,c){if(!this.dataPoints||0===this.dataPoints.length)return null;var b={dataPoint:null,distance:Infinity,index:NaN},e=null,d=0,l=0,k=1,h=Infinity,n=0,p=0,q=0;"none"!==this.chart.plotInfo.axisPlacement&&(this.axisX.logarithmic?(q=Math.log(this.dataPoints[this.dataPoints.length-1].x/this.dataPoints[0].x),q=1<q?Math.min(Math.max((this.dataPoints.length-1)/q*Math.log(a/this.dataPoints[0].x)>>0,0),this.dataPoints.length):0):(q=this.dataPoints[this.dataPoints.length-
1].x-this.dataPoints[0].x,q=0<q?Math.min(Math.max((this.dataPoints.length-1)/q*(a-this.dataPoints[0].x)>>0,0),this.dataPoints.length):0));for(;;){l=0<k?q+d:q-d;if(0<=l&&l<this.dataPoints.length){var e=this.dataPoints[l],r=this.axisX&&this.axisX.logarithmic?e.x>a?e.x/a:a/e.x:Math.abs(e.x-a);r<b.distance&&(m(c)||c&&!m(e.y))&&(b.dataPoint=e,b.distance=r,b.index=l);e=r;e<=h?h=e:0<k?n++:p++;if(1E3<n&&1E3<p)break}else if(0>q-d&&q+d>=this.dataPoints.length)break;-1===k?(d++,k=1):k=-1}return g||(b.dataPoint.x.getTime?
b.dataPoint.x.getTime():b.dataPoint.x)!==(a.getTime?a.getTime():a)?g&&null!==b.dataPoint?b:null:b};T.prototype.getDataPointAtXY=function(a,g,c){if(!this.dataPoints||0===this.dataPoints.length||a<this.chart.plotArea.x1||a>this.chart.plotArea.x2||g<this.chart.plotArea.y1||g>this.chart.plotArea.y2)return null;c=c||!1;var b=[],e=0,d=0,l=1,k=!1,h=Infinity,n=0,p=0,q=0;if("none"!==this.chart.plotInfo.axisPlacement)if(q=(this.chart.axisX[0]?this.chart.axisX[0]:this.chart.axisX2[0]).getXValueAt({x:a,y:g}),
this.axisX.logarithmic)var r=Math.log(this.dataPoints[this.dataPoints.length-1].x/this.dataPoints[0].x),q=1<r?Math.min(Math.max((this.dataPoints.length-1)/r*Math.log(q/this.dataPoints[0].x)>>0,0),this.dataPoints.length):0;else r=this.dataPoints[this.dataPoints.length-1].x-this.dataPoints[0].x,q=0<r?Math.min(Math.max((this.dataPoints.length-1)/r*(q-this.dataPoints[0].x)>>0,0),this.dataPoints.length):0;for(;;){d=0<l?q+e:q-e;if(0<=d&&d<this.dataPoints.length){var r=this.chart._eventManager.objectMap[this.dataPointIds[d]],
f=this.dataPoints[d],u=null;if(r){switch(this.type){case "column":case "stackedColumn":case "stackedColumn100":case "bar":case "stackedBar":case "stackedBar100":case "rangeColumn":case "rangeBar":case "waterfall":case "error":a>=r.x1&&(a<=r.x2&&g>=r.y1&&g<=r.y2)&&(b.push({dataPoint:f,dataPointIndex:d,dataSeries:this,distance:Math.min(Math.abs(r.x1-a),Math.abs(r.x2-a),Math.abs(r.y1-g),Math.abs(r.y2-g))}),k=!0);break;case "line":case "stepLine":case "spline":case "area":case "stepArea":case "stackedArea":case "stackedArea100":case "splineArea":case "scatter":var s=
la("markerSize",f,this)||4,v=c?20:s,u=Math.sqrt(Math.pow(r.x1-a,2)+Math.pow(r.y1-g,2));u<=v&&b.push({dataPoint:f,dataPointIndex:d,dataSeries:this,distance:u});r=Math.abs(r.x1-a);r<=h?h=r:0<l?n++:p++;u<=s/2&&(k=!0);break;case "rangeArea":case "rangeSplineArea":s=la("markerSize",f,this)||4;v=c?20:s;u=Math.min(Math.sqrt(Math.pow(r.x1-a,2)+Math.pow(r.y1-g,2)),Math.sqrt(Math.pow(r.x1-a,2)+Math.pow(r.y2-g,2)));u<=v&&b.push({dataPoint:f,dataPointIndex:d,dataSeries:this,distance:u});r=Math.abs(r.x1-a);r<=
h?h=r:0<l?n++:p++;u<=s/2&&(k=!0);break;case "bubble":s=r.size;u=Math.sqrt(Math.pow(r.x1-a,2)+Math.pow(r.y1-g,2));u<=s/2&&(b.push({dataPoint:f,dataPointIndex:d,dataSeries:this,distance:u}),k=!0);break;case "pie":case "doughnut":s=r.center;v="doughnut"===this.type?r.percentInnerRadius*r.radius:0;u=Math.sqrt(Math.pow(s.x-a,2)+Math.pow(s.y-g,2));u<r.radius&&u>v&&(u=Math.atan2(g-s.y,a-s.x),0>u&&(u+=2*Math.PI),u=Number(((180*(u/Math.PI)%360+360)%360).toFixed(12)),s=Number(((180*(r.startAngle/Math.PI)%360+
360)%360).toFixed(12)),v=Number(((180*(r.endAngle/Math.PI)%360+360)%360).toFixed(12)),0===v&&1<r.endAngle&&(v=360),s>=v&&(0!==f.y&&!m(f.y))&&(v+=360,u<s&&(u+=360)),u>s&&u<v&&(b.push({dataPoint:f,dataPointIndex:d,dataSeries:this,distance:0}),k=!0));break;case "funnel":case "pyramid":u=r.funnelSection;g>=u.y1&&g<u.y4&&(u.y6?g>=u.y6?(d=u.x6+(u.x5-u.x6)/(u.y5-u.y6)*(g-u.y6),u=u.x3+(u.x4-u.x3)/(u.y4-u.y3)*(g-u.y3)):(d=u.x1+(u.x6-u.x1)/(u.y6-u.y1)*(g-u.y1),u=u.x2+(u.x3-u.x2)/(u.y3-u.y2)*(g-u.y2)):(d=u.x1+
(u.x4-u.x1)/(u.y4-u.y1)*(g-u.y1),u=u.x2+(u.x3-u.x2)/(u.y3-u.y2)*(g-u.y2)),a>d&&a<u&&(b.push({dataPoint:f,dataPointIndex:r.dataPointIndex,dataSeries:this,distance:0}),k=!0));break;case "boxAndWhisker":if(a>=r.x1-r.borderThickness/2&&a<=r.x2+r.borderThickness/2&&g>=r.y4-r.borderThickness/2&&g<=r.y1+r.borderThickness/2||Math.abs(r.x2-a+r.x1-a)<r.borderThickness&&g>=r.y1&&g<=r.y4)b.push({dataPoint:f,dataPointIndex:d,dataSeries:this,distance:Math.min(Math.abs(r.x1-a),Math.abs(r.x2-a),Math.abs(r.y2-g),
Math.abs(r.y3-g))}),k=!0;break;case "candlestick":if(a>=r.x1-r.borderThickness/2&&a<=r.x2+r.borderThickness/2&&g>=r.y2-r.borderThickness/2&&g<=r.y3+r.borderThickness/2||Math.abs(r.x2-a+r.x1-a)<r.borderThickness&&g>=r.y1&&g<=r.y4)b.push({dataPoint:f,dataPointIndex:d,dataSeries:this,distance:Math.min(Math.abs(r.x1-a),Math.abs(r.x2-a),Math.abs(r.y2-g),Math.abs(r.y3-g))}),k=!0;break;case "ohlc":if(Math.abs(r.x2-a+r.x1-a)<r.borderThickness&&g>=r.y2&&g<=r.y3||a>=r.x1&&a<=(r.x2+r.x1)/2&&g>=r.y1-r.borderThickness/
2&&g<=r.y1+r.borderThickness/2||a>=(r.x1+r.x2)/2&&a<=r.x2&&g>=r.y4-r.borderThickness/2&&g<=r.y4+r.borderThickness/2)b.push({dataPoint:f,dataPointIndex:d,dataSeries:this,distance:Math.min(Math.abs(r.x1-a),Math.abs(r.x2-a),Math.abs(r.y2-g),Math.abs(r.y3-g))}),k=!0}if(k||1E3<n&&1E3<p)break}}else if(0>q-e&&q+e>=this.dataPoints.length)break;-1===l?(e++,l=1):l=-1}a=null;for(g=0;g<b.length;g++)a?b[g].distance<=a.distance&&(a=b[g]):a=b[g];return a};T.prototype.getMarkerProperties=function(a,g,c,b){var e=
this.dataPoints,d=e[a].markerColor?e[a].markerColor:this.markerColor?this.markerColor:e[a].color?e[a].color:this.color?this.color:this._colorSet[a%this._colorSet.length],l=e[a].markerBorderColor?e[a].markerBorderColor:this.markerBorderColor?this.markerBorderColor:null,k=m(e[a].markerBorderThickness)?this.markerBorderThickness?this.markerBorderThickness:null:e[a].markerBorderThickness,h=e[a].markerType?e[a].markerType:this.markerType;a=m(e[a].markerSize)?this.markerSize:e[a].markerSize;return{x:g,
y:c,ctx:b,type:h,size:a,color:d,borderColor:l,borderThickness:k}};ra(y,S);y.prototype.createExtraLabelsForLog=function(a){a=(a||0)+1;if(!(5<a)){var g=this.logLabelValues[0]||this.intervalStartPosition;if(Math.log(this.range)/Math.log(g/this.viewportMinimum)<this.noTicks-1){for(var c=y.getNiceNumber((g-this.viewportMinimum)/Math.min(Math.max(2,this.noTicks-this.logLabelValues.length),3),!0),b=Math.ceil(this.viewportMinimum/c)*c;b<g;b+=c)b<this.viewportMinimum||this.logLabelValues.push(b);this.logLabelValues.sort(Ua);
this.createExtraLabelsForLog(a)}}};y.prototype.createLabels=function(){var a,g,c=0,b=0,e,d=0,l=0,b=0,b=this.interval,k=0,h,n=0.6*this.chart.height,p;a=!1;var q=this.scaleBreaks?this.scaleBreaks._appliedBreaks:[],r=q.length?m(this.scaleBreaks.firstBreakIndex)?0:this.scaleBreaks.firstBreakIndex:0;if("axisX"!==this.type||"dateTime"!==this.valueType||this.logarithmic){e=this.viewportMaximum;if(this.labels&&m(this.options.interval)){a=Math.ceil(b);for(var b=Math.ceil(this.intervalStartPosition),f=!1,c=
b;c<this.viewportMaximum;c+=a)if(this.labels[c])f=!0;else{f=!1;break}f&&(this.interval=a,this.intervalStartPosition=b)}if(this.logarithmic&&!this.equidistantInterval)for(this.logLabelValues||(this.logLabelValues=[],this.createExtraLabelsForLog()),b=0,f=r;b<this.logLabelValues.length;b++)if(c=this.logLabelValues[b],c<this.viewportMinimum)b++;else{for(;f<q.length&&c>q[f].endValue;f++);a=f<q.length&&c>=q[f].startValue&&c<=q[f].endValue;p=c;a||(a=this.labelFormatter?this.labelFormatter({chart:this.chart,
axis:this.options,value:p,label:this.labels[p]?this.labels[p]:null}):"axisX"===this.type&&this.labels[p]?this.labels[p]:ha(p,this.valueFormatString,this.chart._cultureInfo),a=new ka(this.ctx,{x:0,y:0,maxWidth:d,maxHeight:l,angle:this.labelAngle,text:this.prefix+a+this.suffix,backgroundColor:this.labelBackgroundColor,borderColor:this.labelBorderColor,cornerRadius:this.labelCornerRadius,textAlign:this.labelTextAlign,fontSize:this.labelFontSize,fontFamily:this.labelFontFamily,fontWeight:this.labelFontWeight,
fontColor:this.labelFontColor,fontStyle:this.labelFontStyle,textBaseline:"middle",borderThickness:this.labelBorderThickness,padding:this.labelPadding}),this._labels.push({position:p,textBlock:a,effectiveHeight:null}))}f=r;for(c=this.intervalStartPosition;c<=e;c=parseFloat(this.logarithmic&&this.equidistantInterval?1E-12>c*Math.pow(this.logarithmBase,this.interval)?c*Math.pow(this.logarithmBase,this.interval):(c*Math.pow(this.logarithmBase,this.interval)).toFixed(12):1E-12>this.interval?c+this.interval:
(c+this.interval).toFixed(12))){for(;f<q.length&&c>q[f].endValue;f++);a=f<q.length&&c>=q[f].startValue&&c<=q[f].endValue;p=c;a?(a=Math.floor((q[f].endValue-c)/this.interval),c=parseFloat(1E-12>this.interval?this.logarithmic&&this.equidistantInterval?c*Math.pow(this.logarithmBase,this.interval*a):c+this.interval*a:(this.logarithmic&&this.equidistantInterval?c*Math.pow(this.logarithmBase,this.interval*a):c+this.interval*a).toFixed(12))):(a=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.options,
...
this.labelFontSize;this.sessionVariables.labelMaxWidth=d;this.sessionVariables.labelMaxHeight=l;this.sessionVariables.labelAngle=this.labelAngle;this.sessionVariables.labelWrap=this.labelWrap;for(c=0;c<this._labels.length;c++)if(!this._labels[c].breaksLabelType){a=this._labels[c].textBlock;for(var v,f=a.text.split(" "),b=0;b<f.length;b++)p=f[b],this.ctx.font=a.fontStyle+" "+a.fontWeight+" "+a.fontSize+"px "+a.fontFamily,p=this.ctx.measureText(p),p.width>r&&(v=c,r=p.width)}c=0;for(c=this.intervalStartPosition<
...
Math.cos(Math.PI/180*Math.abs(this.labelAngle));if(m(this.options.labelAngle)&&isNaN(this.options.labelAngle)&&0!==this.options.labelAngle)if(this.sessionVariables.labelMaxHeight=0===this.labelAngle?l:Math.min((b-d*Math.cos(Math.PI/180*Math.abs(this.labelAngle)))/Math.sin(Math.PI/180*Math.abs(this.labelAngle)),b),p=(n-(h+a.fontSize/2)*Math.cos(Math.PI/180*Math.abs(-25)))/Math.sin(Math.PI/180*Math.abs(-25)),!m(this.options.labelWrap))this.labelWrap?m(this.options.labelMaxWidth)?(this.sessionVariables.labelMaxWidth=
Math.min(Math.max(d,r),p),this.sessionVariables.labelWrap=this.labelWrap,g&&s.width+g.width>>0>2*d&&(this.sessionVariables.labelAngle=-25)):(this.sessionVariables.labelWrap=this.labelWrap,this.sessionVariables.labelMaxWidth=this.options.labelMaxWidth,this.sessionVariables.labelAngle=this.sessionVariables.labelMaxWidth>d?-25:this.sessionVariables.labelAngle):m(this.options.labelMaxWidth)?(this.sessionVariables.labelWrap=this.labelWrap,this.sessionVariables.labelMaxHeight=l,this.sessionVariables.labelMaxWidth=
d,g&&s.width+g.width>>0>2*d&&(this.sessionVariables.labelAngle=-25,this.sessionVariables.labelMaxWidth=p)):(this.sessionVariables.labelAngle=this.sessionVariables.labelMaxWidth>d?-25:this.sessionVariables.labelAngle,this.sessionVariables.labelMaxWidth=this.options.labelMaxWidth,this.sessionVariables.labelMaxHeight=l,this.sessionVariables.labelWrap=this.labelWrap);else{if(m(this.options.labelWrap))if(!m(this.options.labelMaxWidth))this.options.labelMaxWidth<d?(this.sessionVariables.labelMaxWidth=this.options.labelMaxWidth,
this.sessionVariables.labelMaxHeight=b):(this.sessionVariables.labelAngle=-25,this.sessionVariables.labelMaxWidth=this.options.labelMaxWidth,this.sessionVariables.labelMaxHeight=l);else if(!m(g))if(b=s.width+g.width>>0,f=this.labelFontSize,r<d)b-2*d>q&&(q=b-2*d,b>=2*d&&b<2.2*d?(this.sessionVariables.labelMaxWidth=d,m(this.options.labelFontSize)&&12<f&&(f=Math.floor(12/13*f),a.measureText()),this.sessionVariables.labelFontSize=m(this.options.labelFontSize)?f:this.options.labelFontSize,this.sessionVariables.labelAngle=
this.labelAngle):b>=2.2*d&&b<2.8*d?(this.sessionVariables.labelAngle=-25,this.sessionVariables.labelMaxWidth=p,this.sessionVariables.labelFontSize=f):b>=2.8*d&&b<3.2*d?(this.sessionVariables.labelMaxWidth=Math.max(d,r),this.sessionVariables.labelWrap=!0,m(this.options.labelFontSize)&&12<this.labelFontSize&&(this.labelFontSize=Math.floor(12/13*this.labelFontSize),a.measureText()),this.sessionVariables.labelFontSize=m(this.options.labelFontSize)?f:this.options.labelFontSize,this.sessionVariables.labelAngle=
this.labelAngle):b>=3.2*d&&b<3.6*d?(this.sessionVariables.labelAngle=-25,this.sessionVariables.labelWrap=!0,this.sessionVariables.labelMaxWidth=p,this.sessionVariables.labelFontSize=this.labelFontSize):b>3.6*d&&b<5*d?(m(this.options.labelFontSize)&&12<f&&(f=Math.floor(12/13*f),a.measureText()),this.sessionVariables.labelFontSize=m(this.options.labelFontSize)?f:this.options.labelFontSize,this.sessionVariables.labelWrap=!0,this.sessionVariables.labelAngle=-25,this.sessionVariables.labelMaxWidth=p):
b>5*d&&(this.sessionVariables.labelWrap=!0,this.sessionVariables.labelMaxWidth=d,this.sessionVariables.labelFontSize=f,this.sessionVariables.labelMaxHeight=l,this.sessionVariables.labelAngle=this.labelAngle));else if(v===c&&(0===v&&r+this._labels[v+1].textBlock.measureText().width-2*d>q||v===this._labels.length-1&&r+this._labels[v-1].textBlock.measureText().width-2*d>q||0<v&&v<this._labels.length-1&&r+this._labels[v+1].textBlock.measureText().width-2*d>q&&r+this._labels[v-1].textBlock.measureText().width-
...
this.sessionVariables.labelMaxHeight=l:this.sessionVariables.labelMaxHeight,a.measureText();else if("left"===this._position||"right"===this._position)if(d=m(this.options.labelMaxWidth)?0.3*this.chart.width>>0:this.options.labelMaxWidth,l="undefined"===typeof this.options.labelWrap||this.labelWrap?0.3*this.chart.height>>0:1.5*this.labelFontSize,!this.chart.panEnabled&&1<=this._labels.length){this.sessionVariables.labelFontSize=this.labelFontSize;this.sessionVariables.labelMaxWidth=d;this.sessionVariables.labelMaxHeight=
l;this.sessionVariables.labelAngle=m(this.sessionVariables.labelAngle)?0:this.sessionVariables.labelAngle;this.sessionVariables.labelWrap=this.labelWrap;for(c=0;c<this._labels.length;c++)if(!this._labels[c].breaksLabelType){a=this._labels[c].textBlock;s=a.measureText();for(f=c+1;f<this._labels.length;f++)if(!this._labels[f].breaksLabelType){g=this._labels[f].textBlock;g=g.measureText();break}e.push(a.height);this.sessionVariables.labelMaxHeight=Math.max.apply(Math,e);b=d*Math.sin(Math.PI/180*Math.abs(this.labelAngle))+
(l-a.fontSize/2)*Math.cos(Math.PI/180*Math.abs(this.labelAngle));Math.cos(Math.PI/180*Math.abs(this.labelAngle));Math.sin(Math.PI/180*Math.abs(this.labelAngle));m(this.options.labelAngle)&&isNaN(this.options.labelAngle)&&0!==this.options.labelAngle?m(this.options.labelWrap)?m(this.options.labelWrap)&&(m(this.options.labelMaxWidth)?m(g)||(k=s.height+g.height>>0,k-2*l>r&&(r=k-2*l,k>=2*l&&k<2.4*l?(m(this.options.labelFontSize)&&12<this.labelFontSize&&(this.labelFontSize=Math.floor(12/13*this.labelFontSize),
a.measureText()),this.sessionVariables.labelMaxHeight=l,this.sessionVariables.labelFontSize=m(this.options.labelFontSize)?this.labelFontSize:this.options.labelFontSize):k>=2.4*l&&k<2.8*l?(this.sessionVariables.labelMaxHeight=b,this.sessionVariables.labelFontSize=this.labelFontSize,this.sessionVariables.labelWrap=!0):k>=2.8*l&&k<3.2*l?(this.sessionVariables.labelMaxHeight=l,this.sessionVariables.labelWrap=!0,m(this.options.labelFontSize)&&12<this.labelFontSize&&(this.labelFontSize=Math.floor(12/13*
this.labelFontSize),a.measureText()),this.sessionVariables.labelFontSize=m(this.options.labelFontSize)?this.labelFontSize:this.options.labelFontSize,this.sessionVariables.labelAngle=m(this.sessionVariables.labelAngle)?0:this.sessionVariables.labelAngle):k>=3.2*l&&k<3.6*l?(this.sessionVariables.labelMaxHeight=b,this.sessionVariables.labelWrap=!0,this.sessionVariables.labelFontSize=this.labelFontSize):k>3.6*l&&k<10*l?(m(this.options.labelFontSize)&&12<this.labelFontSize&&(this.labelFontSize=Math.floor(12/
13*this.labelFontSize),a.measureText()),this.sessionVariables.labelFontSize=m(this.options.labelFontSize)?this.labelFontSize:this.options.labelFontSize,this.sessionVariables.labelMaxWidth=d,this.sessionVariables.labelMaxHeight=l,this.sessionVariables.labelAngle=m(this.sessionVariables.labelAngle)?0:this.sessionVariables.labelAngle):k>10*l&&k<50*l&&(m(this.options.labelFontSize)&&12<this.labelFontSize&&(this.labelFontSize=Math.floor(12/13*this.labelFontSize),a.measureText()),this.sessionVariables.labelFontSize=
m(this.options.labelFontSize)?this.labelFontSize:this.options.labelFontSize,this.sessionVariables.labelMaxHeight=l,this.sessionVariables.labelMaxWidth=d,this.sessionVariables.labelAngle=m(this.sessionVariables.labelAngle)?0:this.sessionVariables.labelAngle))):(this.sessionVariables.labelMaxHeight=l,this.sessionVariables.labelMaxWidth=this.options.labelMaxWidth?this.options.labelMaxWidth:this.sessionVariables.labelMaxWidth)):(this.sessionVariables.labelMaxWidth=this.labelWrap?this.options.labelMaxWidth?
this.options.labelMaxWidth:this.sessionVariables.labelMaxWidth:this.labelMaxWidth?this.options.labelMaxWidth?this.options.labelMaxWidth:this.sessionVariables.labelMaxWidth:d,this.sessionVariables.labelMaxHeight=l):(this.sessionVariables.labelAngle=this.labelAngle,this.sessionVariables.labelMaxWidth=0===this.labelAngle?d:Math.min((b-l*Math.sin(Math.PI/180*Math.abs(this.labelAngle)))/Math.cos(Math.PI/180*Math.abs(this.labelAngle)),l),m(this.options.labelWrap))?m(this.options.labelWrap)&&(this.labelWrap&&
...
(this.sessionVariables.labelMaxHeight=0===this.labelAngle?l:b,this.sessionVariables.labelWrap=this.labelWrap,this.sessionVariables.labelMaxWidth=d):(this.sessionVariables.labelMaxHeight=l,m(this.options.labelMaxWidth),this.sessionVariables.labelMaxWidth=this.options.labelMaxWidth?this.options.labelMaxWidth:this.sessionVariables.labelMaxWidth,this.sessionVariables.labelWrap=this.labelWrap)}for(b=0;b<this._labels.length;b++)a=this._labels[b].textBlock,a.maxWidth=this.labelMaxWidth=this.sessionVariables.labelMaxWidth,
a.fontSize=this.labelFontSize=this.sessionVariables.labelFontSize,a.angle=this.labelAngle=this.sessionVariables.labelAngle,a.wrap=this.labelWrap=this.sessionVariables.labelWrap,a.maxHeight=this.sessionVariables.labelMaxHeight,a.measureText()}else for(m(this.chart.stockChart)||this.chart.isNavigator||(this.sessionVariables.labelMaxHeight=l),c=0;c<this._labels.length;c++)a=this._labels[c].textBlock,a.maxWidth=this.labelMaxWidth=m(this.options.labelMaxWidth)?m(this.sessionVariables.labelMaxWidth)?this.sessionVariables.labelMaxWidth=
...
m(this.sessionVariables.labelWrap)?this.sessionVariables.labelWrap=this.labelWrap:this.sessionVariables.labelWrap:this.options.labelWrap,a.maxHeight=m(this.sessionVariables.labelMaxHeight)?this.sessionVariables.labelMaxHeight=l:this.sessionVariables.labelMaxHeight,a.measureText();for(c=0;c<this.stripLines.length;c++){var d=this.stripLines[c],y;d.labelFontSize="outside"===d.labelPlacement&&m(d.options.labelFontSize)?this.labelFontSize:d.labelFontSize;d.labelFontFamily="outside"===d.labelPlacement&&
m(d.options.labelFontFamily)?this.labelFontFamily:d.labelFontFamily;d.labelFontWeight="outside"===d.labelPlacement&&m(d.options.labelFontWeight)?this.labelFontWeight:d.labelFontWeight;d.labelFontStyle="outside"===d.labelPlacement&&m(d.options.labelFontStyle)?this.labelFontStyle:d.labelFontStyle;if("outside"===d.labelPlacement){l=this.sessionVariables.labelMaxWidth;if("bottom"===this._position||"top"===this._position)m(d.options.labelWrap)&&!m(this.sessionVariables.stripLineLabelMaxHeight)?y=this.sessionVariables.stripLineLabelMaxHeight:
...
(d.labelPadding.top||0)+(d.labelPadding.bottom||0):2*d.labelPadding);m(d.labelBackgroundColor)&&(d.labelBackgroundColor="#EEEEEE")}else l="bottom"===this._position||"top"===this._position?0.9*this.chart.width>>0:0.9*this.chart.height>>0,y=m(d.options.labelWrap)||d.labelWrap?"bottom"===this._position||"top"===this._position?0.8*this.chart.width>>0:0.8*this.chart.height>>0:1.5*d.labelFontSize+("object"===typeof d.labelPadding?(d.labelPadding.top||0)+(d.labelPadding.bottom||0):2*d.labelPadding),m(d.labelBackgroundColor)&&
(m(d.startValue)&&0!==d.startValue?d.labelBackgroundColor=u?"transparent":null:d.labelBackgroundColor="#EEEEEE");a=new ka(this.ctx,{x:0,y:0,backgroundColor:d.labelBackgroundColor,borderColor:d.labelBorderColor,borderThickness:d.labelBorderThickness,cornerRadius:d.labelCornerRadius,maxWidth:d.options.labelMaxWidth?d.options.labelMaxWidth:l,maxHeight:y,angle:this.labelAngle,text:d.labelFormatter?d.labelFormatter({chart:this.chart,axis:this,stripLine:d}):d.label,textAlign:d.labelTextAlign,fontSize:d.labelFontSize,
fontFamily:d.labelFontFamily,fontWeight:d.labelFontWeight,fontColor:d.labelFontColor||d.color,fontStyle:d.labelFontStyle,textBaseline:"middle",padding:d.labelPadding});this._stripLineLabels.push({position:d.value,textBlock:a,effectiveHeight:null,stripLine:d})}};y.prototype.createLabelsAndCalculateWidth=function(){var a=0,g=0;this._labels=[];this._stripLineLabels=[];var c=0,b=[],e=this.chart.isNavigator?0:5;this.labelEffectiveWidth=m(this.labelEffectiveWidth)?0:this.labelEffectiveWidth;if("left"===
...
this.viewportMinimum&&this._stripLineLabels[g].stripLine.value<=this.viewportMaximum)&&(d=this._stripLineLabels[g].textBlock,d=d.measureText(),l=0===this.labelAngle?d.width:d.width*Math.cos(Math.PI/180*Math.abs(this.labelAngle))+d.height*Math.sin(Math.PI/180*Math.abs(this.labelAngle)),c=Math.max(c,this._stripLineLabels[g].stripLine.tickLength),"inside"===this.labelPlacement&&(a-=0<b.length?Math.max.apply(null,b):0,a+=Math.max(l,0<b.length?Math.max.apply(null,b):l)),a<=l&&(a=l),this.stripLineLabelEffectiveWidth=
this._stripLineLabels[g].effectiveWidth=l,b.push(l));"inside"===this.labelPlacement&&(a+=e)}return(this.title?this._titleTextBlock.measureText().height+2:0)+a+("inside"===this.tickPlacement?c+this.tickLength:Math.max(c,this.tickLength))+e};y.prototype.createLabelsAndCalculateHeight=function(){var a=0;this._labels=[];this._stripLineLabels=[];var g=0,c,b=0,e=this.chart.isNavigator?0:"bottom"===this._position&&"inside"===this.labelPlacement||"top"===this._position&&"outside"===this.labelPlacement?2:
5;this.labelEffectiveHeight=m(this.labelEffectiveHeight)?0:this.labelEffectiveHeight;var d=[];if("bottom"===this._position||"top"===this._position){this.createLabels();for(b=0;b<this._labels.length;b++){c=this._labels[b].textBlock;c=c.measureText();var l=0,l=0===this.labelAngle?c.height:c.width*Math.sin(Math.PI/180*Math.abs(this.labelAngle))+c.height*Math.cos(Math.PI/180*Math.abs(this.labelAngle));a<=l&&(this.labelEffectiveHeight=a=l);this._labels[b].effectiveHeight=l}for(b=0;b<this._stripLineLabels.length;b++)"outside"===
...
d):0,a+=Math.max(l,0<d.length?Math.max.apply(null,d):l)),a<=l&&(a=l),this.stripLineLabelEffectiveHeight=this._stripLineLabels[b].effectiveHeight=l,d.push(l));"inside"===this.labelPlacement&&(a+=e)}return(this.title?this._titleTextBlock.measureText().height+2:0)+a+("inside"===this.tickPlacement?g+this.tickLength:Math.max(g,this.tickLength))+e};y.setLayout=function(a,g,c,b,e,d){var l,k,h,n,p=a[0]?a[0].chart:g[0].chart,q=p.isNavigator?0:10,r=p._axes;if(a&&0<a.length)for(var f=0;f<a.length;f++)a[f]&&
a[f].calculateAxisParameters();if(g&&0<g.length)for(f=0;f<g.length;f++)g[f].calculateAxisParameters();if(c&&0<c.length)for(f=0;f<c.length;f++)c[f].calculateAxisParameters();if(b&&0<b.length)for(f=0;f<b.length;f++)b[f].calculateAxisParameters();for(f=0;f<r.length;f++)if(r[f]&&r[f].scaleBreaks&&r[f].scaleBreaks._appliedBreaks.length)for(var u=r[f].scaleBreaks._appliedBreaks,s=0;s<u.length&&!(u[s].startValue>r[f].viewportMaximum);s++)u[s].endValue<r[f].viewportMinimum||(m(r[f].scaleBreaks.firstBreakIndex)&&
(r[f].scaleBreaks.firstBreakIndex=s),u[s].startValue>=r[f].viewPortMinimum&&(r[f].scaleBreaks.lastBreakIndex=s));for(var v=s=0,t=0,x=0,w=0,y=0,z=0,D,F,H=k=0,I,M,L,u=I=M=L=!1,f=0;f<r.length;f++)r[f]&&r[f].title&&(r[f]._titleTextBlock=new ka(r[f].ctx,{text:r[f].title,fontSize:r[f].titleFontSize,fontFamily:r[f].titleFontFamily,fontWeight:r[f].titleFontWeight,fontColor:r[f].titleFontColor,fontStyle:r[f].titleFontStyle,borderColor:r[f].titleBorderColor,borderThickness:r[f].titleBorderThickness,backgroundColor:r[f].titleBackgroundColor,
cornerRadius:r[f].titleCornerRadius,textBaseline:"middle",textAlign:r[f].titleTextAlign,padding:r[f].titlePadding}));for(f=0;f<r.length;f++)if(r[f].title){var J=1.5*r[f].titleFontSize+("object"===typeof r[f].titlePadding?(r[f].titlePadding.top||0)+(r[f].titlePadding.bottom||0):2*r[f].titlePadding);r[f]._titleTextBlock.maxWidth=r[f].titleMaxWidth||d.height;r[f]._titleTextBlock.maxHeight=r[f].titleWrap?0.8*d.width:Math.min(J,0.8*d.width);switch(r[f]._position){case "left":r[f]._titleTextBlock.angle=
-90;break;case "right":r[f]._titleTextBlock.angle=90;break;default:r[f]._titleTextBlock.maxWidth=r[f].titleMaxWidth||d.width,r[f]._titleTextBlock.maxHeight=r[f].titleWrap?0.8*d.height:Math.min(J,0.8*d.height),r[f]._titleTextBlock.angle=0}}if("normal"===e){for(var x=[],w=[],y=[],z=[],O=[],R=[],S=[],E=[];4>s;){var W=0,V=0,U=0,T=0,$=J=e=0,aa=0,X=0,Y=0,N=l=0;if(c&&0<c.length)for(y=[],f=l=0;f<c.length;f++)y.push(Math.ceil(c[f]?c[f].createLabelsAndCalculateWidth():0)),l+=y[f],$+=c[f]&&!p.isNavigator?c[f].margin:
0;else y.push(Math.ceil(c[0]?c[0].createLabelsAndCalculateWidth():0));S.push(y);if(b&&0<b.length)for(z=[],f=N=0;f<b.length;f++)z.push(Math.ceil(b[f]?b[f].createLabelsAndCalculateWidth():0)),N+=z[f],aa+=b[f]?b[f].margin:0;else z.push(Math.ceil(b[0]?b[0].createLabelsAndCalculateWidth():0));E.push(z);l=Math.round(d.x1+l+$-(c[0]?("inside"===c[0].labelPlacement?c[0].labelEffectiveWidth+(p.isNavigator?0:5):0)+("inside"===c[0].tickPlacement?c[0].tickLength:0):0))+(!c.length||"inside"!==c[c.length-1].labelPlacement||
c[c.length-1].title||c[c.length-1].stripLineLabelEffectiveWidth||p.isNavigator?0:5);h=Math.round(Math.min(d.x2-N-aa+(b[0]?("inside"===b[0].labelPlacement?b[0].labelEffectiveWidth+(p.isNavigator?0:5):0)+("inside"===b[0].tickPlacement?b[0].tickLength:0):0),p.width-q));if(a&&0<a.length)for(x=[],f=X=0;f<a.length;f++)a[f]&&(a[f].lineCoordinates={}),a[f].lineCoordinates.width=Math.abs(h-l),a[f].title&&(a[f]._titleTextBlock.maxWidth=0<a[f].titleMaxWidth&&a[f].titleMaxWidth<a[f].lineCoordinates.width?a[f].titleMaxWidth:
...
g[f].createLabelsAndCalculateHeight():0)),Y+=w[f],J+=g[f]&&!p.isNavigator?g[f].margin:0;else w.push(Math.ceil(g[0]?g[0].createLabelsAndCalculateHeight():0));R.push(w);if(a&&0<a.length){for(f=0;f<a.length;f++){if(a[f]){a[f].lineCoordinates.x1=l;h=Math.round(Math.min(d.x2-N-aa+(b[0]?("inside"===b[0].labelPlacement?b[0].labelEffectiveWidth+(p.isNavigator?0:5):0)+("inside"===b[0].tickPlacement?b[0].tickLength:0):0)-(!b.length||"inside"!==b[b.length-1].labelPlacement||b[b.length-1].title||b[b.length-1].stripLineLabelEffectiveWidth||
p.isNavigator?0:5),p.width-q));if(a[f]._labels&&1<a[f]._labels.length){var Q=k=0;k=a[f]._labels[1];Q="dateTime"===a[f].valueType?a[f]._labels[a[f]._labels.length-2]:a[f]._labels[a[f]._labels.length-1];v=k.textBlock.width*Math.cos(Math.PI/180*Math.abs(k.textBlock.angle))+(k.textBlock.height-k.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(k.textBlock.angle));t=Q.textBlock.width*Math.cos(Math.PI/180*Math.abs(Q.textBlock.angle))+Q.textBlock.height*Math.sin(Math.PI/180*Math.abs(Q.textBlock.angle))}!a[f]||
(!a[f].labelAutoFit||m(D)||m(F)||p.isNavigator||p.stockChart)||(k=0,0<a[f].labelAngle?(n=t-(Q.textBlock.height-Q.textBlock._lineHeight/2)*Math.sin(Math.PI/180*Q.textBlock.angle),F+n>h&&(a[f].convertPixelToValue(F)>=a[f].viewportMinimum&&a[f].convertPixelToValue(F)<=a[f].viewportMaximum)&&(k+=F+n-h-N)):0>a[f].labelAngle?D-v<l&&D-v<a[f].viewportMinimum&&(H=l-($+a[f].tickLength+y+D-v+a[f].labelFontSize/2)):0===a[f].labelAngle&&(F+t>h&&(a[f].convertPixelToValue(F)>=a[f].viewportMinimum&&a[f].convertPixelToValue(F)<=
a[f].viewportMaximum)&&(k=F+t/2-h-N),D-v<l&&D-v<a[f].viewportMinimum&&(H=l-$-a[f].tickLength-y-D+v/2)),a[f].viewportMaximum===a[f].maximum&&a[f].viewportMinimum===a[f].minimum&&0<a[f].labelAngle&&0<k?h-=k:a[f].viewportMaximum===a[f].maximum&&a[f].viewportMinimum===a[f].minimum&&0>a[f].labelAngle&&0<H?l+=H:a[f].viewportMaximum===a[f].maximum&&a[f].viewportMinimum===a[f].minimum&&0===a[f].labelAngle&&(0<H&&(l+=H),0<k&&(h-=k)));p.panEnabled?X=m(p.sessionVariables.axisX.height)||p.stockChart?p.sessionVariables.axisX.height=
X:p.sessionVariables.axisX.height:p.sessionVariables.axisX.height=X;k=Math.round(d.y2-X-e+W)-("inside"!==a[a.length-1].labelPlacement||a[a.length-1].title||a[a.length-1].stripLineLabelEffectiveHeight||p.isNavigator?0:5);n=Math.round(d.y2)-("inside"!==a[a.length-1].labelPlacement||a[a.length-1].title||a[a.length-1].stripLineLabelEffectiveHeight||p.isNavigator?0:5);a[f].lineCoordinates.x2=h;a[f].lineCoordinates.width=h-l;a[f].lineCoordinates.y1=k;a[f].lineCoordinates.y2=k;a[f].bounds={x1:l,y1:k,x2:h,
y2:n-(X+e-x[f]-W),width:h-l};a[f].bounds.height=a[f].bounds.y2-a[f].bounds.y1;"inside"===a[f].labelPlacement&&(a[f].lineCoordinates.y1=a[0].bounds.y1+W+(a[f].labelEffectiveHeight||0)+(p.isNavigator?0:2),a[f].lineCoordinates.y2=a[f].lineCoordinates.y1+a[f].lineThickness/2);"inside"===a[f].tickPlacement&&(a[f].lineCoordinates.y1+=a[f].tickLength,a[f].lineCoordinates.y2=a[f].lineCoordinates.y1+a[f].lineThickness/2)}W+=x[f]+a[f].margin}$=0===a[0].dataSeries.length;if(!$)for(f=0;f<a[0].dataSeries.length;f++){if(a[0].dataSeries[f].dataPoints){$=
!1;break}$=!0}if($)for($=!1,f=1;f<a.length;f++)0!==a[f].dataSeries.length&&($?a[f].lineCoordinates.x2>a[0].lineCoordinates.x2&&(a[0].lineCoordinates.x2=a[f].lineCoordinates.x2):(a[0].lineCoordinates.x2=a[f].lineCoordinates.x2,$=!0),a[0].lineCoordinates.width=a[0].lineCoordinates.x2-a[0].lineCoordinates.x1)}if(g&&0<g.length)for(f=0;f<g.length;f++)g[f].lineCoordinates.x1=l,g[f].lineCoordinates.x2=h,g[f].lineCoordinates.width=Math.abs(h-l),g[f]._labels&&1<g[f]._labels.length&&(k=g[f]._labels[1],Q="dateTime"===
g[f].valueType?g[f]._labels[g[f]._labels.length-2]:g[f]._labels[g[f]._labels.length-1],v=k.textBlock.width*Math.cos(Math.PI/180*Math.abs(k.textBlock.angle))+(k.textBlock.height-Q.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(k.textBlock.angle)),t=Q.textBlock.width*Math.cos(Math.PI/180*Math.abs(Q.textBlock.angle))+(Q.textBlock.height-Q.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(Q.textBlock.angle))),p.panEnabled?Y=m(p.sessionVariables.axisX2.height)||p.stockChart?p.sessionVariables.axisX2.height=
Y:p.sessionVariables.axisX2.height:p.sessionVariables.axisX2.height=Y,k=Math.round(d.y1)+("inside"!==g[g.length-1].labelPlacement||g[g.length-1].title||g[g.length-1].stripLineLabelEffectiveHeight||p.isNavigator?0:5),n=g[f].lineCoordinates.y1=k+Y+J-V,g[f].lineCoordinates.y2=k,g[f].bounds={x1:l,y1:k+(Y+J-w[f]-V),x2:h,y2:n,width:h-l},g[f].bounds.height=g[f].bounds.y2-g[f].bounds.y1,"inside"===g[f].labelPlacement&&(g[f].lineCoordinates.y1=g[0].bounds.y2-V-(g[f].labelEffectiveHeight||0)-5),"inside"===
g[f].tickPlacement&&(g[f].lineCoordinates.y1-=g[f].tickLength),V+=w[f]+g[f].margin;if(c&&0<c.length)for(f=0;f<c.length;f++)$=p.isNavigator?0:10,c[f]&&(l=h=Math.round((a[0]?a[0].lineCoordinates.x1:g[0].lineCoordinates.x1)+(c[0]?("inside"===c[0].labelPlacement?c[0].labelEffectiveWidth+(p.isNavigator?0:5):0)+("inside"===c[0].tickPlacement?c[0].tickLength:0):0)),$=Math.max(c[f]._labels&&0<c[f]._labels.length?c[f]._labels[c[f]._labels.length-1].textBlock._lineHeight/2:q,q),k=Math.round(Math.max(d.y1+Y+
...
a[0].tickLength:0):0)-e-$)-(!a.length||"inside"!==a[a.length-1].labelPlacement||a[a.length-1].title||a[a.length-1].stripLineLabelEffectiveHeight||p.isNavigator?0:5),c[f].lineCoordinates={x1:l-U,y1:k,x2:h-U,y2:n,height:Math.abs(n-k)},c[f].bounds={x1:l-(y[f]+U),y1:k,x2:h-U,y2:n,height:n-k},c[f].bounds.width=c[f].bounds.x2-c[f].bounds.x1,"inside"===c[f].labelPlacement&&(c[f].lineCoordinates.x1=Math.round(c[0].bounds.x1+y[0]-U-(c[f].labelEffectiveWidth||0)-5),c[f].lineCoordinates.x2=c[f].lineCoordinates.x1+
c[f].lineThickness/2),"inside"===c[f].tickPlacement&&(c[f].lineCoordinates.x1-=c[f].tickLength,c[f].lineCoordinates.x2=c[f].lineCoordinates.x1+c[f].lineThickness/2),c[f].title&&(c[f]._titleTextBlock.maxWidth=0<c[f].titleMaxWidth&&c[f].titleMaxWidth<c[f].lineCoordinates.height?c[f].titleMaxWidth:c[f].lineCoordinates.height),U+=y[f]+c[f].margin);if(b&&0<b.length)for(f=0;f<b.length;f++)b[f]&&(l=h=Math.round((a[0]?a[0].lineCoordinates.x2:g[0].lineCoordinates.x2)-(b[0]?("inside"===b[0].labelPlacement?
b[0].labelEffectiveWidth+(p.isNavigator?0:5):0)+("inside"===b[0].tickPlacement?b[0].tickLength:0):0)),$=Math.max(b[f]._labels&&0<b[f]._labels.length?b[f]._labels[b[f]._labels.length-1].textBlock.height/2:0,q),k=Math.round(Math.max(d.y1+Y+J-(g[0]?("inside"===g[0].labelPlacement?g[0].labelEffectiveHeight+(p.isNavigator?0:5):0)+("inside"===g[0].tickPlacement?g[0].tickLength:0):0)+(!g.length||"inside"!==g[g.length-1].labelPlacement||g[g.length-1].title||g[g.length-1].stripLineLabelEffectiveHeight||p.isNavigator?
0:5),0<g.length?0:$)),$=0<a.length?0:b[f]._labels&&0<b[f]._labels.length?b[f]._labels[0].textBlock.height/2:0,n=Math.round(d.y2-(X+e+$)+(a[0]?("inside"===a[0].labelPlacement?a[0].labelEffectiveHeight+(p.isNavigator?0:2):0)+("inside"===a[0].tickPlacement?a[0].tickLength:0):0))-(!a.length||"inside"!==a[a.length-1].labelPlacement||a[a.length-1].title||a[a.length-1].stripLineLabelEffectiveHeight||p.isNavigator?0:5),b[f].lineCoordinates={x1:l+T,y1:k,x2:l+T,y2:n,height:Math.abs(n-k)},b[f].bounds={x1:l+
T,y1:k,x2:h+z[f]+T,y2:n,height:n-k},b[f].bounds.width=b[f].bounds.x2-b[f].bounds.x1,"inside"===b[f].labelPlacement&&(b[f].lineCoordinates.x1=Math.round(b[0].bounds.x1+T+(b[f].labelEffectiveWidth||0)+(p.isNavigator?0:5)),b[f].lineCoordinates.x2=b[f].lineCoordinates.x1+b[f].lineThickness/2),"inside"===b[f].tickPlacement&&(b[f].lineCoordinates.x1+=b[f].tickLength,b[f].lineCoordinates.x2=b[f].lineCoordinates.x1+b[f].lineThickness/2),b[f].title&&(b[f]._titleTextBlock.maxWidth=0<b[f].titleMaxWidth&&b[f].titleMaxWidth<
b[f].lineCoordinates.height?b[f].titleMaxWidth:b[f].lineCoordinates.height),T+=z[f]+b[f].margin);if(a&&0<a.length)for(f=0;f<a.length;f++)a[f]&&(a[f].calculateValueToPixelConversionParameters(),a[f].calculateBreaksSizeInValues(),a[f]._labels&&1<a[f]._labels.length&&(D=(a[f].logarithmic?Math.log(a[f]._labels[1].position/a[f].viewportMinimum)/a[f].conversionParameters.lnLogarithmBase:a[f]._labels[1].position-a[f].viewportMinimum)*Math.abs(a[f].conversionParameters.pixelPerUnit)+a[f].lineCoordinates.x1,
l=a[f]._labels[a[f]._labels.length-("dateTime"===a[f].valueType?2:1)].position,l=a[f].getApparentDifference(a[f].viewportMinimum,l),F=a[f].logarithmic?(1<l?Math.log(l)/a[f].conversionParameters.lnLogarithmBase*Math.abs(a[f].conversionParameters.pixelPerUnit):0)+a[f].lineCoordinates.x1:(0<l?l*Math.abs(a[f].conversionParameters.pixelPerUnit):0)+a[f].lineCoordinates.x1));if(g&&0<g.length)for(f=0;f<g.length;f++)g[f].calculateValueToPixelConversionParameters(),g[f].calculateBreaksSizeInValues(),g[f]._labels&&
1<g[f]._labels.length&&(D=(g[f].logarithmic?Math.log(g[f]._labels[1].position/g[f].viewportMinimum)/g[f].conversionParameters.lnLogarithmBase:g[f]._labels[1].position-g[f].viewportMinimum)*Math.abs(g[f].conversionParameters.pixelPerUnit)+g[f].lineCoordinates.x1,l=g[f]._labels[g[f]._labels.length-("dateTime"===g[f].valueType?2:1)].position,l=g[f].getApparentDifference(g[f].viewportMinimum,l),F=g[f].logarithmic?(1<l?Math.log(l)/g[f].conversionParameters.lnLogarithmBase*Math.abs(g[f].conversionParameters.pixelPerUnit):
0)+g[f].lineCoordinates.x1:(0<l?l*Math.abs(g[f].conversionParameters.pixelPerUnit):0)+g[f].lineCoordinates.x1);for(f=0;f<r.length;f++)"axisY"===r[f].type&&(r[f].calculateValueToPixelConversionParameters(),r[f].calculateBreaksSizeInValues());if(0<s){if(a&&0<a.length)for(f=0;f<a.length;f++)u=O[s-1][f]===O[s][f]?!0:!1;else u=!0;if(g&&0<g.length)for(f=0;f<g.length;f++)I=R[s-1][f]===R[s][f]?!0:!1;else I=!0;if(c&&0<c.length)for(f=0;f<c.length;f++)M=S[s-1][f]===S[s][f]?!0:!1;else M=!0;if(b&&0<b.length)for(f=
0;f<b.length;f++)L=E[s-1][f]===E[s][f]?!0:!1;else L=!0}if(u&&I&&M&&L)break;s++}if(a&&0<a.length)for(f=0;f<a.length;f++)a[f].calculateStripLinesThicknessInValues(),a[f].calculateBreaksInPixels();if(g&&0<g.length)for(f=0;f<g.length;f++)g[f].calculateStripLinesThicknessInValues(),g[f].calculateBreaksInPixels();if(c&&0<c.length)for(f=0;f<c.length;f++)c[f].calculateStripLinesThicknessInValues(),c[f].calculateBreaksInPixels();if(b&&0<b.length)for(f=0;f<b.length;f++)b[f].calculateStripLinesThicknessInValues(),
...
g[0].createLabelsAndCalculateWidth():0));R.push(v);if(c&&0<c.length)for(f=0;f<c.length;f++)c[f].lineCoordinates={},l=Math.round(d.x1+T+e-(a[0]?("inside"===a[0].labelPlacement?a[0].labelEffectiveWidth+(p.isNavigator?0:5):0)+("inside"===a[0].tickPlacement?a[0].tickLength:0):0))+(!a.length||"inside"!==a[a.length-1].labelPlacement||a[a.length-1].title||a[a.length-1].stripLineLabelEffectiveWidth||p.isNavigator?0:5),h=Math.round(Math.min(d.x2-X-J+(g[0]?("inside"===g[0].labelPlacement?g[0].labelEffectiveWidth+
(p.isNavigator?0:5):0)+("inside"===g[0].tickPlacement?g[0].tickLength:0):0)-(!g.length||"inside"!==g[g.length-1].labelPlacement||g[g.length-1].title||g[g.length-1].stripLineLabelEffectiveWidth||p.isNavigator?0:5),p.width-10)),c[f].labelAutoFit&&!m(x)&&(0<!a.length&&(l=0>c[f].labelAngle?Math.max(l,x):0===c[f].labelAngle?Math.max(l,x/2):l),0<!g.length&&(h=0<c[f].labelAngle?h-w/2:0===c[f].labelAngle?h-w/2:h)),c[f].lineCoordinates.x1=l,c[f].lineCoordinates.x2=h,c[f].lineCoordinates.width=Math.abs(h-l),
c[f].title&&(c[f]._titleTextBlock.maxWidth=0<c[f].titleMaxWidth&&c[f].titleMaxWidth<c[f].lineCoordinates.width?c[f].titleMaxWidth:c[f].lineCoordinates.width);if(b&&0<b.length)for(f=0;f<b.length;f++)b[f].lineCoordinates={},l=Math.round(d.x1+T+e-(a[0]?("inside"===a[0].labelPlacement?a[0].labelEffectiveWidth+(p.isNavigator?0:5):0)+("inside"===a[0].tickPlacement?a[0].tickLength:0):0))+(!a.length||"inside"!==a[a.length-1].labelPlacement||a[a.length-1].title||a[a.length-1].stripLineLabelEffectiveWidth||
p.isNavigator?0:5),h=Math.round(Math.min(d.x2-X-J+(g[0]?("inside"===g[0].labelPlacement?g[0].labelEffectiveWidth+(p.isNavigator?0:5):0)+("inside"===g[0].tickPlacement?g[0].tickLength:0):0)-(!g.length||"inside"!==g[g.length-1].labelPlacement||g[g.length-1].title||g[g.length-1].stripLineLabelEffectiveWidth||p.isNavigator?0:5),b[f].chart.width-10)),b[f]&&b[f].labelAutoFit&&!m(y)&&(0<!a.length&&(l=0<b[f].labelAngle?Math.max(l,y):0===b[f].labelAngle?Math.max(l,y/2):l),0<!g.length&&(h-=z/2)),b[f].lineCoordinates.x1=
l,b[f].lineCoordinates.x2=h,b[f].lineCoordinates.width=Math.abs(h-l),b[f].title&&(b[f]._titleTextBlock.maxWidth=0<b[f].titleMaxWidth&&b[f].titleMaxWidth<b[f].lineCoordinates.width?b[f].titleMaxWidth:b[f].lineCoordinates.width);if(c&&0<c.length)for(q=[],f=U=0;f<c.length;f++)q.push(Math.ceil(c[f]?c[f].createLabelsAndCalculateHeight():0)),U+=q[f]+c[f].margin,$+=c[f].margin;else q.push(Math.ceil(c[0]?c[0].createLabelsAndCalculateHeight():0));t.push(q);if(b&&0<b.length)for(D=[],f=0;f<b.length;f++)D.push(Math.ceil(b[f]?
b[f].createLabelsAndCalculateHeight():0)),aa+=b[f].margin;else D.push(Math.ceil(b[0]?b[0].createLabelsAndCalculateHeight():0));F.push(D);if(c&&0<c.length)for(f=0;f<c.length;f++)0<c[f]._labels.length&&(k=c[f]._labels[0],Q=c[f]._labels[c[f]._labels.length-1],x=k.textBlock.width*Math.cos(Math.PI/180*Math.abs(k.textBlock.angle))+(k.textBlock.height-Q.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(k.textBlock.angle)),w=Q.textBlock.width*Math.cos(Math.PI/180*Math.abs(Q.textBlock.angle))+(Q.textBlock.height-
...
if(p.panEnabled)for(f=0;f<c.length;f++)q[f]=m(p.sessionVariables.axisY[f].height)?p.sessionVariables.axisY[f].height=q[f]:p.sessionVariables.axisY[f].height;else for(f=0;f<c.length;f++)p.sessionVariables.axisY[f].height=q[f];if(c&&0<c.length)for(f=c.length-1;0<=f;f--)k=Math.round(d.y2)-("inside"!==c[c.length-1].labelPlacement||c[c.length-1].title||c[c.length-1].stripLineLabelEffectiveHeight||p.isNavigator?0:5),n=Math.round(d.y2>c[f].chart.height?c[f].chart.height:d.y2)-("inside"!==c[c.length-1].labelPlacement||
c[c.length-1].title||c[c.length-1].stripLineLabelEffectiveHeight||p.isNavigator?0:5),c[f].lineCoordinates.y1=k-(q[f]+c[f].margin+Y),c[f].lineCoordinates.y2=k-(q[f]+c[f].margin+Y),"inside"===c[f].labelPlacement&&(c[f].lineCoordinates.y1=c[f].lineCoordinates.y1+c[f].labelEffectiveHeight+(p.isNavigator?0:2),c[f].lineCoordinates.y2=c[f].lineCoordinates.y1+c[f].lineThickness/2),"inside"===c[f].tickPlacement&&(c[f].lineCoordinates.y1+=c[f].tickLength,c[f].lineCoordinates.y2=c[f].lineCoordinates.y1+c[f].lineThickness/
2),c[f].bounds={x1:l,y1:k-(q[f]+Y+c[f].margin),x2:h,y2:n-(Y+c[f].margin),width:h-l,height:q[f]},c[f].title&&(c[f]._titleTextBlock.maxWidth=0<c[f].titleMaxWidth&&c[f].titleMaxWidth<c[f].lineCoordinates.width?c[f].titleMaxWidth:c[f].lineCoordinates.width),Y+=q[f]+c[f].margin;if(b&&0<b.length)for(f=b.length-1;0<=f;f--)b[f]&&(k=Math.round(d.y1)+("inside"!==b[b.length-1].labelPlacement||b[b.length-1].title||b[b.length-1].stripLineLabelEffectiveHeight||p.isNavigator?0:5),n=Math.round(d.y1+(D[f]+b[f].margin+
V))+("inside"!==b[b.length-1].labelPlacement||b[b.length-1].title||b[b.length-1].stripLineLabelEffectiveHeight||p.isNavigator?0:5),b[f].lineCoordinates.y1=n,b[f].lineCoordinates.y2=n,"inside"===b[f].labelPlacement&&(b[f].lineCoordinates.y1=n-b[f].labelEffectiveHeight-5,b[f].lineCoordinates.y2=b[f].lineCoordinates.y1-b[f].lineThickness/2),"inside"===b[f].tickPlacement&&(b[f].lineCoordinates.y1-=b[f].tickLength,b[f].lineCoordinates.y2=b[f].lineCoordinates.y1-b[f].lineThickness/2),b[f].bounds={x1:l,
y1:k+(b[f].margin+V),x2:h,y2:n,width:h-l},b[f].bounds.height=b[f].bounds.y2-b[f].bounds.y1,b[f].title&&(b[f]._titleTextBlock.maxWidth=0<b[f].titleMaxWidth&&b[f].titleMaxWidth<b[f].lineCoordinates.width?b[f].titleMaxWidth:b[f].lineCoordinates.width),V+=D[f]+b[f].margin);if(a&&0<a.length)for(f=0;f<a.length;f++){$=a[f]._labels&&0<a[f]._labels.length?a[f]._labels[0].textBlock.fontSize/2:0;l=Math.round(d.x1+e);k=b&&0<b.length?Math.round(b[0]?b[0].lineCoordinates.y2:d.y1<Math.max($,10)?Math.max($,10):d.y1):
d.y1<Math.max($,10)?Math.max($,10):d.y1;h=Math.round(d.x1+T+e);n=c&&0<c.length?Math.round(c[0]?c[0].lineCoordinates.y1:d.y2-U>p.height-Math.max($,10)?p.height-Math.max($,10):d.y2-U):d.y2>p.height-Math.max($,10)?p.height-Math.max($,10):d.y2;if(c&&0<c.length)for(Q=0;Q<c.length;Q++)c[Q]&&c[Q].labelAutoFit&&(h=c[Q].lineCoordinates.x1+(a[0]?("inside"===a[0].labelPlacement?a[0].labelEffectiveWidth+(p.isNavigator?0:5):0)+("inside"===a[0].tickPlacement?a[0].tickLength:0):0),l=0>c[Q].labelAngle||0===c[Q].labelAngle?
h-T:l);if(b&&0<b.length)for(Q=0;Q<b.length;Q++)b[Q]&&b[Q].labelAutoFit&&(h=b[Q].lineCoordinates.x1+(a[0]?("inside"===a[0].labelPlacement?a[0].labelEffectiveWidth+(p.isNavigator?0:5):0)+("inside"===a[0].tickPlacement?a[0].tickLength:0):0),l=h-T);a[f].lineCoordinates={x1:h-S,y1:k,x2:h-S,y2:n,height:Math.abs(n-k)};"inside"===a[f].labelPlacement&&(a[f].lineCoordinates.x1=a[f].lineCoordinates.x1-a[f].labelEffectiveWidth-5,a[f].lineCoordinates.x2=a[f].lineCoordinates.x1+a[f].lineThickness/2);"inside"===
a[f].tickPlacement&&(a[f].lineCoordinates.x1-=a[f].tickLength,a[f].lineCoordinates.x2=a[f].lineCoordinates.x1+a[f].lineThickness/2);a[f].bounds={x1:h-(H[f]+S),y1:k,x2:h-S,y2:n,height:n-k};a[f].bounds.width=a[f].bounds.x2-a[f].bounds.x1;a[f].title&&(a[f]._titleTextBlock.maxWidth=0<a[f].titleMaxWidth&&a[f].titleMaxWidth<a[f].lineCoordinates.height?a[f].titleMaxWidth:a[f].lineCoordinates.height);a[f].calculateValueToPixelConversionParameters();a[f].calculateBreaksSizeInValues();S+=H[f]+a[f].margin}if(g&&
0<g.length)for(f=0;f<g.length;f++){$=g[f]._labels&&0<g[f]._labels.length?g[f]._labels[0].textBlock.fontSize/2:0;h=Math.round(d.x1-J);k=b&&0<b.length?Math.round(b[0]?b[0].lineCoordinates.y2:d.y1<Math.max($,10)?Math.max($,10):d.y1):d.y1<Math.max($,10)?Math.max($,10):d.y1;l=Math.round(d.x2-X-J);n=c&&0<c.length?Math.round(c[0]?c[0].lineCoordinates.y1:d.y2-U>p.height-Math.max($,10)?p.height-Math.max($,10):d.y2-U):d.y2>p.height-Math.max($,10)?p.height-Math.max($,10):d.y2;if(c&&0<c.length)for(Q=0;Q<c.length;Q++)c[Q]&&
c[Q].labelAutoFit&&(l=c[Q].lineCoordinates.x2-(g[0]?("inside"===g[0].labelPlacement?g[0].labelEffectiveWidth+(p.isNavigator?0:5):0)+("inside"===g[0].tickPlacement?g[0].tickLength:0):0),h=0>c[Q].labelAngle||0===c[Q].labelAngle?l+X:l);if(b&&0<b.length)for(Q=0;Q<b.length;Q++)b[Q]&&b[Q].labelAutoFit&&(l=b[Q].lineCoordinates.x2-(g[0]?("inside"===g[0].labelPlacement?g[0].labelEffectiveWidth+(p.isNavigator?0:5):0)+("inside"===g[0].tickPlacement?g[0].tickLength:0):0),h=l+X);g[f].lineCoordinates={x1:l+E,y1:k,
x2:l+E,y2:n,height:Math.abs(n-k)};"inside"===g[f].labelPlacement&&(g[f].lineCoordinates.x1=g[f].lineCoordinates.x1+g[f].labelEffectiveWidth+(p.isNavigator?0:5),g[f].lineCoordinates.x2=g[f].lineCoordinates.x1+g[f].lineThickness/2);"inside"===g[f].tickPlacement&&(g[f].lineCoordinates.x1+=g[f].tickLength,g[f].lineCoordinates.x2=g[f].lineCoordinates.x1+g[f].lineThickness/2);g[f].bounds={x1:l+E,y1:k,x2:l+v[f]+E,y2:n,height:n-k};g[f].bounds.width=g[f].bounds.x2-g[f].bounds.x1;g[f].title&&(g[f]._titleTextBlock.maxWidth=
0<g[f].titleMaxWidth&&g[f].titleMaxWidth<g[f].lineCoordinates.height?g[f].titleMaxWidth:g[f].lineCoordinates.height);g[f].calculateValueToPixelConversionParameters();g[f].calculateBreaksSizeInValues();E+=v[f]+g[f].margin}for(f=0;f<r.length;f++)"axisY"===r[f].type&&(r[f].calculateValueToPixelConversionParameters(),r[f].calculateBreaksSizeInValues());if(0<s){if(a&&0<a.length)for(f=0;f<a.length;f++)u=O[s-1][f]===O[s][f]?!0:!1;else u=!0;if(g&&0<g.length)for(f=0;f<g.length;f++)I=R[s-1][f]===R[s][f]?!0:
...
null);for(var g=0;g<a.length&&!(a[g].startValue>this.conversionParameters.maximum);g++)a[g].endValue<this.conversionParameters.minimum||(m(this.scaleBreaks.firstBreakIndex)&&(this.scaleBreaks.firstBreakIndex=g),a[g].startValue>=this.conversionParameters.minimum&&(a[g].startPixel=this.convertValueToPixel(a[g].startValue),this.scaleBreaks.lastBreakIndex=g),a[g].endValue<=this.conversionParameters.maximum&&(a[g].endPixel=this.convertValueToPixel(a[g].endValue)))}};y.prototype.renderLabelsTicksAndTitle=
function(){var a=this,g=!1,c=0,b=0,e=1,d=0;0!==this.labelAngle&&360!==this.labelAngle&&(e=1.2);if("undefined"===typeof this.options.interval){if("bottom"===this._position||"top"===this._position)if(this.logarithmic&&!this.equidistantInterval&&this.labelAutoFit){for(var c=[],e=0!==this.labelAngle&&360!==this.labelAngle?1:1.2,l,k=this.viewportMaximum,m=this.lineCoordinates.width/Math.log(this.range),n=this._labels.length-1;0<=n;n--){q=this._labels[n];if(q.position<this.viewportMinimum)break;q.position>
this.viewportMaximum||!(n===this._labels.length-1||l<Math.log(k/q.position)*m/e)||(c.push(q),k=q.position,l=q.textBlock.width*Math.abs(Math.cos(Math.PI/180*this.labelAngle))+q.textBlock.height*Math.abs(Math.sin(Math.PI/180*this.labelAngle)))}this._labels=c}else{for(n=0;n<this._labels.length;n++)q=this._labels[n],q.position<this.viewportMinimum||(l=q.textBlock.width*Math.abs(Math.cos(Math.PI/180*this.labelAngle))+q.textBlock.height*Math.abs(Math.sin(Math.PI/180*this.labelAngle)),c+=l);c>this.lineCoordinates.width*
e&&this.labelAutoFit&&(g=!0)}if("left"===this._position||"right"===this._position)if(this.logarithmic&&!this.equidistantInterval&&this.labelAutoFit){for(var c=[],h,k=this.viewportMaximum,m=this.lineCoordinates.height/Math.log(this.range),n=this._labels.length-1;0<=n;n--){q=this._labels[n];if(q.position<this.viewportMinimum)break;q.position>this.viewportMaximum||!(n===this._labels.length-1||h<Math.log(k/q.position)*m)||(c.push(q),k=q.position,h=q.textBlock.height*Math.abs(Math.cos(Math.PI/180*this.labelAngle))+
...
var n=0,q,r;if("bottom"===this._position){for(n=0;n<this._labels.length;n++)q=this._labels[n],q.position<this.viewportMinimum||q.position>this.viewportMaximum||(r=this.getPixelCoordinatesOnAxis(q.position),this.tickThickness&&"inside"!=this.tickPlacement&&(this.ctx.lineWidth=this.tickThickness,this.ctx.strokeStyle=this.tickColor,b=1===this.ctx.lineWidth%2?(r.x<<0)+0.5:r.x<<0,this.ctx.beginPath(),this.ctx.moveTo(b,r.y<<0),this.ctx.lineTo(b,r.y+this.tickLength<<0),this.ctx.stroke()),g&&0!==d++%2&&this.labelAutoFit||
(0===q.textBlock.angle?(r.x-=q.textBlock.width/2,r.y="inside"===this.labelPlacement?r.y-(("inside"===this.tickPlacement?this.tickLength:0)+q.textBlock.height-q.textBlock._lineHeight/2+2):r.y+("inside"===this.tickPlacement?0:this.tickLength)+q.textBlock._lineHeight/2+5):0>this.labelAngle?(r.x=r.x-("inside"===this.labelPlacement?0:q.textBlock.width*Math.cos(Math.PI/180*this.labelAngle))+q.textBlock.topPadding*Math.sin(Math.PI/180*this.labelAngle),r.y="inside"===this.labelPlacement?r.y-("inside"===this.tickPlacement?
this.tickLength:0)-2-(q.textBlock.height-q.textBlock._lineHeight/2)*Math.cos(Math.PI/180*this.labelAngle):r.y+("inside"===this.tickPlacement?0:this.tickLength)+5+Math.abs(q.textBlock.width*Math.sin(Math.PI/180*this.labelAngle)-q.textBlock._lineHeight/2*Math.cos(Math.PI/180*this.labelAngle))):(r.x=r.x-("inside"===this.labelPlacement?q.textBlock.width*Math.cos(Math.PI/180*this.labelAngle):0)+q.textBlock.topPadding*Math.sin(Math.PI/180*this.labelAngle),r.y="inside"===this.labelPlacement?r.y-("inside"===
this.tickPlacement?this.tickLength:0)-2-q.textBlock.width*Math.sin(Math.PI/180*this.labelAngle)-(q.textBlock.height-q.textBlock._lineHeight/2)*Math.cos(Math.PI/180*this.labelAngle):r.y+("inside"===this.tickPlacement?0:this.tickLength)+5+Math.abs(q.textBlock._lineHeight/2*Math.cos(Math.PI/180*this.labelAngle))),q.textBlock.x=r.x,q.textBlock.y=r.y));"inside"===this.tickPlacement&&this.chart.addEventListener("dataAnimationIterationEnd",function(){for(n=0;n<a._labels.length;n++)if(q=a._labels[n],!(q.position<
...
b=1===this.ctx.lineWidth%2?(r.x<<0)+0.5:r.x<<0,this.ctx.beginPath(),this.ctx.moveTo(b,r.y<<0),this.ctx.lineTo(b,r.y-this.tickLength<<0),this.ctx.stroke()),g&&0!==d++%2&&this.labelAutoFit||(0===q.textBlock.angle?(r.x-=q.textBlock.width/2,r.y="inside"===this.labelPlacement?r.y+q.textBlock._lineHeight/2+("inside"===this.tickPlacement?this.tickLength:0)+5:r.y-(("inside"===this.tickPlacement?0:this.tickLength)+q.textBlock.height-q.textBlock._lineHeight/2)-2):0>this.labelAngle?(r.x=r.x-("inside"===this.labelPlacement?
q.textBlock.width*Math.cos(Math.PI/180*this.labelAngle):0)+q.textBlock.topPadding*Math.sin(Math.PI/180*this.labelAngle),r.y="inside"===this.labelPlacement?r.y+("inside"===this.tickPlacement?this.tickLength:0)+5-q.textBlock.width*Math.sin(Math.PI/180*this.labelAngle)+q.textBlock._lineHeight/2*Math.cos(Math.PI/180*this.labelAngle):r.y-("inside"===this.tickPlacement?0:this.tickLength)-2-(q.textBlock.height-q.textBlock._lineHeight/2)*Math.cos(Math.PI/180*this.labelAngle)):(r.x=r.x-("inside"===this.labelPlacement?
0:q.textBlock.width*Math.cos(Math.PI/180*this.labelAngle))+q.textBlock.topPadding*Math.sin(Math.PI/180*this.labelAngle),r.y="inside"===this.labelPlacement?r.y+("inside"===this.tickPlacement?this.tickLength:0)+5+q.textBlock._lineHeight/2*Math.cos(Math.PI/180*this.labelAngle):r.y-("inside"===this.tickPlacement?0:this.tickLength)-2-((q.textBlock.height-q.textBlock._lineHeight/2)*Math.cos(Math.PI/180*this.labelAngle)+q.textBlock.width*Math.sin(Math.PI/180*this.labelAngle))),q.textBlock.x=r.x,q.textBlock.y=
r.y));"inside"===this.tickPlacement&&this.chart.addEventListener("dataAnimationIterationEnd",function(){for(n=0;n<a._labels.length;n++)if(q=a._labels[n],!(q.position<a.viewportMinimum||q.position>a.viewportMaximum)&&(r=a.getPixelCoordinatesOnAxis(q.position),a.tickThickness)){a.ctx.lineWidth=a.tickThickness;a.ctx.strokeStyle=a.tickColor;var b=1===a.ctx.lineWidth%2?(r.x<<0)+0.5:r.x<<0;a.ctx.save();a.ctx.beginPath();a.ctx.moveTo(b,r.y<<0);a.ctx.lineTo(b,r.y+a.tickLength<<0);a.ctx.stroke();a.ctx.restore()}},
...
0;if("inside"===this.labelPlacement)this.chart.addEventListener("dataAnimationIterationEnd",function(){for(n=0;n<a._labels.length;n++)q=a._labels[n],q.position<a.viewportMinimum||(q.position>a.viewportMaximum||g&&0!==d++%2&&a.labelAutoFit)||(a.ctx.save(),a.ctx.beginPath(),q.textBlock.render(!0),a.ctx.restore())},this);else for(n=0;n<this._labels.length;n++)q=this._labels[n],q.position<this.viewportMinimum||(q.position>this.viewportMaximum||g&&0!==d++%2&&this.labelAutoFit)||q.textBlock.render(!0)};
...
function(a){if(this.stripLines&&0<this.stripLines.length&&a){var g=this,c,b,e=0,d=0,l=!1;b=!1;for(var k=[],h=[],n=!1,p,e=0;e<this.stripLines.length;e++){var q=this.stripLines[e];q._thicknessType===a&&("pixel"===a&&(q.value<this.viewportMinimum||q.value>this.viewportMaximum||m(q.value)||isNaN(this.range))||"value"===a&&(q.startValue<=this.viewportMinimum&&q.endValue<=this.viewportMinimum||q.startValue>=this.viewportMaximum&&q.endValue>=this.viewportMaximum||m(q.startValue)||m(q.endValue)||isNaN(this.range))||
k.push(q))}for(e=0;e<this._stripLineLabels.length;e++)if(q=this.stripLines[e],c=this._stripLineLabels[e],!(c.position<this.viewportMinimum||c.position>this.viewportMaximum||isNaN(this.range)))if(b=this.getPixelCoordinatesOnAxis(c.position),"outside"===c.stripLine.labelPlacement){q&&(this.ctx.strokeStyle=q.tickColor?q.tickColor:q.color,this.ctx.lineWidth=q.tickThickness=m(q.tickThickness)?"pixel"===q._thicknessType?q.thickness:this.thickness:q.tickThickness,m(q.opacity)||"pixel"!==q._thicknessType||
(p=q.ctx.globalAlpha,q.ctx.globalAlpha=q.opacity));if("bottom"===this._position){var r=1===this.ctx.lineWidth%2?(b.x<<0)+0.5:b.x<<0;0<q.tickThickness&&(this.ctx.beginPath(),this.ctx.moveTo(r,b.y<<0),this.ctx.lineTo(r,b.y+q.tickLength<<0),this.ctx.stroke());0===this.labelAngle?(b.x-=c.textBlock.width/2,b.y+=q.tickLength+c.textBlock.fontSize/2+5):(b.x-=(0>this.labelAngle?c.textBlock.width*Math.cos(Math.PI/180*this.labelAngle):0)-c.textBlock.topPadding*Math.sin(Math.PI/180*this.labelAngle),b.y+=q.tickLength+
5+(0>this.labelAngle?Math.abs(c.textBlock.width*Math.sin(Math.PI/180*this.labelAngle)-c.textBlock.fontSize/2*Math.cos(Math.PI/180*this.labelAngle)):Math.abs(c.textBlock.fontSize/2*Math.cos(Math.PI/180*this.labelAngle))))}else"top"===this._position?(r=1===this.ctx.lineWidth%2?(b.x<<0)+0.5:b.x<<0,0<q.tickThickness&&(this.ctx.beginPath(),this.ctx.moveTo(r,b.y<<0),this.ctx.lineTo(r,b.y-q.tickLength<<0),this.ctx.stroke()),0===this.labelAngle?(b.x-=c.textBlock.width/2,b.y-=q.tickLength+c.textBlock.height-
c.textBlock.fontSize/2):(b.x-=(0<this.labelAngle?c.textBlock.width*Math.cos(Math.PI/180*this.labelAngle):0)-c.textBlock.topPadding*Math.sin(Math.PI/180*this.labelAngle),b.y-=q.tickLength+2+(0<this.labelAngle?(c.textBlock.height-c.textBlock.fontSize/2)*Math.cos(Math.PI/180*this.labelAngle)+c.textBlock.width*Math.sin(Math.PI/180*this.labelAngle):(c.textBlock.height-c.textBlock.fontSize/2)*Math.cos(Math.PI/180*this.labelAngle)))):"left"===this._position?(r=1===this.ctx.lineWidth%2?(b.y<<0)+0.5:b.y<<
0,0<q.tickThickness&&(this.ctx.beginPath(),this.ctx.moveTo(b.x<<0,r),this.ctx.lineTo(b.x-q.tickLength<<0,r),this.ctx.stroke()),0===this.labelAngle?(b.x=b.x-c.textBlock.width*Math.cos(Math.PI/180*this.labelAngle)-q.tickLength-5,b.y-=c.textBlock.topPadding):(b.y-=c.textBlock.width*Math.sin(Math.PI/180*this.labelAngle)+c.textBlock.topPadding*Math.cos(Math.PI/180*this.labelAngle),b.x-=q.tickLength+5+(0<this.labelAngle?c.textBlock.width*Math.cos(Math.PI/180*this.labelAngle)+c.textBlock.fontSize/2*Math.sin(Math.PI/
...
b.x-=c.textBlock.height-c.textBlock.fontSize/2+q.thickness/2:b.x-=c.textBlock.height/2-c.textBlock.fontSize/2:(c.textBlock.angle=90,m(q.startValue)?b.x+=c.textBlock.height-c.textBlock.fontSize/2+q.thickness/2:b.x+=c.textBlock.height/2-c.textBlock.fontSize/2),b.y=-90===c.textBlock.angle?"near"===c.stripLine.labelAlign?this.chart.plotArea.y1+c.textBlock.width+3:"center"===c.stripLine.labelAlign?(this.chart.plotArea.y2+this.chart.plotArea.y1+c.textBlock.width)/2:this.chart.plotArea.y2-3:"near"===c.stripLine.labelAlign?
this.chart.plotArea.y1+3:"center"===c.stripLine.labelAlign?(this.chart.plotArea.y2+this.chart.plotArea.y1-c.textBlock.width)/2:this.chart.plotArea.y2-c.textBlock.width-3):"left"===this._position?(c.textBlock.maxWidth=this.options.stripLines[e].labelMaxWidth?this.options.stripLines[e].labelMaxWidth:this.chart.plotArea.width-3,c.textBlock.angle=0,c.textBlock.measureText(),b.y-c.textBlock.height-q.thickness/2>this.chart.plotArea.y1?m(q.startValue)?b.y-=c.textBlock.height-c.textBlock.fontSize/2+q.thickness/
2:b.y-=c.textBlock.height/2-c.textBlock.fontSize/2:m(q.startValue)?b.y+=c.textBlock.height-c.textBlock.fontSize/2+q.thickness/2:b.y+=c.textBlock.height/2-c.textBlock.fontSize+3,b.x="near"===c.stripLine.labelAlign?this.chart.plotArea.x1+3:"center"===c.stripLine.labelAlign?(this.chart.plotArea.x2+this.chart.plotArea.x1)/2-c.textBlock.width/2:this.chart.plotArea.x2-c.textBlock.width-3):"right"===this._position&&(c.textBlock.maxWidth=this.options.stripLines[e].labelMaxWidth?this.options.stripLines[e].labelMaxWidth:
...
this.chart._breaksCanvasCtx.rect(this.chart.plotArea.x1,this.chart.plotArea.y1,this.chart.plotArea.width,this.chart.plotArea.height),this.chart._breaksCanvasCtx.clip(),this.chart._breaksCanvasCtx.drawImage(this.maskCanvas,0,0,this.chart.width,this.chart.height),this.chart._breaksCanvasCtx.restore())};y.prototype.createMask=function(){if(this.scaleBreaks&&0<this.scaleBreaks._appliedBreaks.length){var a=this.scaleBreaks._appliedBreaks;u?(this.maskCanvas=wa(this.chart.width,this.chart.height),this.maskCtx=
...
0.5<<0:this.conversionParameters.reference+this.conversionParameters.pixelPerUnit*(a-this.conversionParameters.minimum)+0.5};y.prototype.getApparentDifference=function(a,g,c,b){var e=this.scaleBreaks?this.scaleBreaks._appliedBreaks:[];if(this.logarithmic){c=m(c)?g/a:c;for(var d=0;d<e.length&&!(g<e[d].startValue);d++)a>e[d].endValue||(a<=e[d].startValue&&g>=e[d].endValue?c=c/e[d].endValue*e[d].startValue*e[d].size:a>=e[d].startValue&&g>=e[d].endValue?c=c/e[d].endValue*a*Math.pow(e[d].size,Math.log(e[d].endValue/
a)/Math.log(e[d].endValue/e[d].startValue)):a<=e[d].startValue&&g<=e[d].endValue?c=c/g*e[d].startValue*Math.pow(e[d].size,Math.log(g/e[d].startValue)/Math.log(e[d].endValue/e[d].startValue)):!b&&(a>e[d].startValue&&g<e[d].endValue)&&(c=a*Math.pow(e[d].size,Math.log(g/a)/Math.log(e[d].endValue/e[d].startValue))))}else for(c=m(c)?Math.abs(g-a):c,d=0;d<e.length&&!(g<e[d].startValue);d++)a>e[d].endValue||(a<=e[d].startValue&&g>=e[d].endValue?c=c-e[d].endValue+e[d].startValue+e[d].size:a>e[d].startValue&&
...
!m(this.options.maximum)&&this.options.maximum<=this.scaleBreaks._appliedBreaks[b].endValue||!m(this.options.viewportMaximum)&&this.viewportMaximum<=this.scaleBreaks._appliedBreaks[b].endValue)){this.scaleBreaks._appliedBreaks.splice(b,1);break}if("axisX"===this.type){if(this.dataSeries&&0<this.dataSeries.length)for(e=0;e<this.dataSeries.length;e++)"dateTime"===this.dataSeries[e].xValueType&&(c=!0);e=null!==this.viewportMinimum?this.viewportMinimum:this.dataInfo.viewPortMin;d=null!==this.viewportMaximum?
this.viewportMaximum:this.dataInfo.viewPortMax;0===d-e&&(b="undefined"===typeof this.options.interval?0.4:this.options.interval,d+=b,e-=b);Infinity!==this.dataInfo.minDiff?l=this.dataInfo.minDiff:1<d-e?l=0.5*Math.abs(d-e):(l=1,c&&(g=!0))}else"axisY"===this.type&&(e=null!==this.viewportMinimum?this.viewportMinimum:this.dataInfo.viewPortMin,d=null!==this.viewportMaximum?this.viewportMaximum:this.dataInfo.viewPortMax,l=Math.pow(2,50),isFinite(e)||isFinite(d)?isFinite(e)?isFinite(d)||(d=e):e=d:(d="undefined"===
...
isNaN(this.maximum))&&0>d&&(d=0)),Math.abs(this.getApparentDifference(e,d,null,!0)),"axisX"===this.type&&c){this.valueType="dateTime";if(null===this.minimum||isNaN(this.minimum))this.minimum=e-l/2,this.minimum=Math.min(this.minimum,null===this.sessionVariables.viewportMinimum||isNaN(this.sessionVariables.viewportMinimum)?Infinity:this.sessionVariables.viewportMinimum);if(null===this.maximum||isNaN(this.maximum))this.maximum=d+l/2,this.maximum=Math.max(this.maximum,null===this.sessionVariables.viewportMaximum||
isNaN(this.sessionVariables.viewportMaximum)?-Infinity:this.sessionVariables.viewportMaximum)}else this.intervalType=this.valueType="number",null===this.minimum&&(this.minimum="axisX"===this.type?e-l/2:Math.floor(e/this.interval)*this.interval,this.minimum=Math.min(this.minimum,null===this.sessionVariables.viewportMinimum||isNaN(this.sessionVariables.viewportMinimum)?Infinity:this.sessionVariables.viewportMinimum)),null===this.maximum&&(this.maximum="axisX"===this.type?d+l/2:Math.ceil(d/this.interval)*
this.interval,this.maximum=Math.max(this.maximum,null===this.sessionVariables.viewportMaximum||isNaN(this.sessionVariables.viewportMaximum)?-Infinity:this.sessionVariables.viewportMaximum)),0===this.maximum&&0===this.minimum&&(0===this.options.minimum?this.maximum+=10:0===this.options.maximum&&(this.minimum-=10));m(this.sessionVariables.newViewportMinimum)&&(this.viewportMinimum=Math.max(this.viewportMinimum,this.minimum));m(this.sessionVariables.newViewportMaximum)&&(this.viewportMaximum=Math.min(this.viewportMaximum,
...
c;"bottom"===this._position||"top"===this._position?(this.maxWidth=a.width,this.maxHeight=a.height):(this.maxWidth=a.height,this.maxHeight=a.width);var a="axisX"===this.type?500>this.maxWidth?7:Math.max(7,Math.floor(this.maxWidth/100)):Math.max(Math.floor(this.maxWidth/50),3),b,e,d,l;l=1;if(null===this.viewportMinimum||isNaN(this.viewportMinimum))this.viewportMinimum=this.minimum;if(null===this.viewportMaximum||isNaN(this.viewportMaximum))this.viewportMaximum=this.maximum;if(this.scaleBreaks)for(l=
0;l<this.scaleBreaks._appliedBreaks.length;l++)if((!m(this.sessionVariables.newViewportMinimum)&&this.sessionVariables.newViewportMinimum>=this.scaleBreaks._appliedBreaks[l].startValue||!m(this.options.minimum)&&this.options.minimum>=this.scaleBreaks._appliedBreaks[l].startValue||!m(this.options.viewportMinimum)&&this.viewportMinimum>=this.scaleBreaks._appliedBreaks[l].startValue)&&(!m(this.sessionVariables.newViewportMaximum)&&this.sessionVariables.newViewportMaximum<=this.scaleBreaks._appliedBreaks[l].endValue||
!m(this.options.maximum)&&this.options.maximum<=this.scaleBreaks._appliedBreaks[l].endValue||!m(this.options.viewportMaximum)&&this.viewportMaximum<=this.scaleBreaks._appliedBreaks[l].endValue)){this.scaleBreaks._appliedBreaks.splice(l,1);break}"axisX"===this.type?(b=null!==this.viewportMinimum?this.viewportMinimum:this.dataInfo.viewPortMin,e=null!==this.viewportMaximum?this.viewportMaximum:this.dataInfo.viewPortMax,1===e/b&&(l=Math.pow(this.logarithmBase,"undefined"===typeof this.options.interval?
...
1/this.logarithmBase,b=1):1===e/b?(l=Math.min(e*Math.pow(this.logarithmBase,0.01),Math.pow(this.logarithmBase,5)),e*=l,b/=l):b>e?(l=Math.min(b/e*Math.pow(this.logarithmBase,0.01),Math.pow(this.logarithmBase,5)),1<=e?b=e/l:e=b*l):(l=Math.min(e/b*Math.pow(this.logarithmBase,0.01),Math.pow(this.logarithmBase,0.04)),1!==e&&(e*=l),1!==b&&(b/=l)),d=Infinity!==this.dataInfo.minDiff?this.dataInfo.minDiff:e/b>this.logarithmBase?e/b*Math.pow(this.logarithmBase,0.5):this.logarithmBase,this.includeZero&&(null===
...
g=Math.abs("pixel"===this._thicknessType?this.thickness:Math.abs(this.parent.convertValueToPixel(this.endValue)-this.parent.convertValueToPixel(this.startValue)));if(0<g){var c=null===this.opacity?1:this.opacity;this.ctx.strokeStyle=this.color;this.ctx.beginPath();var b=this.ctx.globalAlpha;this.ctx.globalAlpha=c;W(this.id);var e,d,l,k;this.ctx.lineWidth=g;this.ctx.setLineDash&&this.ctx.setLineDash(H(this.lineDashType,g));if("bottom"===this.parent._position||"top"===this.parent._position)a="pixel"===
this._thicknessType?a.x:(this.parent.convertValueToPixel(this.endValue)+this.parent.convertValueToPixel(this.startValue))/2,e=d=1===this.ctx.lineWidth%2?(a<<0)+0.5:a<<0,l=this.chart.plotArea.y1,k=this.chart.plotArea.y2,this.bounds={x1:e-g/2,y1:l,x2:d+g/2,y2:k};else if("left"===this.parent._position||"right"===this.parent._position)a="pixel"===this._thicknessType?a.y:(this.parent.convertValueToPixel(this.endValue)+this.parent.convertValueToPixel(this.startValue))/2,l=k=1===this.ctx.lineWidth%2?(a<<
...
"top"===this.parent._position?b=e?g.axisY2:g.axisX2:"left"===this.parent._position?b=e?g.axisX:g.axisY:"right"===this.parent._position&&(b=e?g.axisX2:g.axisY2);if(b)for(e=0;e<b.length;e++)this.parent===b[e]&&(b[e]._crosshairValue=a>=b[e].viewportMinimum&&a<=b[e].viewportMaximum?a:null);b=["axisX","axisX2","axisY","axisY2"];for(e=0;e<b.length;e++)for(var d=b[e],l=0;l<g[d].length;l++){var k=g[d][l],h=k._crosshairValue;k.crosshair&&k.crosshair.enabled&&(this.parent===k&&(k.sessionVariables.crosshairShownByPixel=
...
(this.chart.toolTip._entries&&this.chart.sessionVariables._dataHighlighted)&&this.chart.toolTip.highlightObjects(this.chart.toolTip._entries);this.chart.renderCrosshairs(this.parent,!1);this.parent.sessionVariables._crosshairHidden=this._hidden=!0};ga.prototype.render=function(a,g,c){var b,e,d,l,k=null,h=null,n=null,p="";this.valueFormatString||("dateTime"===this.parent.valueType?this.valueFormatString=this.parent.valueFormatString:(n=0,n="xySwapped"===this.chart.plotInfo.axisPlacement?50<this.parent.range?
0:500<this.chart.width&&25>this.parent.range?2:Math.floor(Math.abs(Math.log(this.parent.range)/Math.LN10))+(5>this.parent.range?2:10>this.parent.range?1:0):50<this.parent.range?0:Math.floor(Math.abs(Math.log(this.parent.range)/Math.LN10))+(5>this.parent.range?2:10>this.parent.range?1:0),this.valueFormatString=y.generateValueFormatString(this.parent.range,n)));var q=null===this.opacity?1:this.opacity,r=Math.abs("pixel"===this._thicknessType?this.thickness:this.parent.conversionParameters.pixelPerUnit*
this.thickness),f=this.chart.overlaidCanvasCtx,u=f.globalAlpha;f.beginPath();f.strokeStyle=this.color;f.lineWidth=r;f.save();this.labelFontSize=Math.abs(m(this.options.labelFontSize)?this.parent.labelFontSize:this.labelFontSize);this.labelMaxWidth=m(this.options.labelMaxWidth)?0.3*this.chart.width:this.labelMaxWidth;this.labelMaxHeight=m(this.options.labelWrap)||this.labelWrap?0.3*this.chart.height:1.5*this.labelFontSize+("object"===typeof this.labelPadding?(this.labelPadding.top||0)+(this.labelPadding.bottom||
...
if(this.snapToDataPoint){var s=0,p=[];if("xySwapped"===this.chart.plotInfo.axisPlacement){var v=null;if("bottom"===this.parent._position||"top"===this.parent._position)s=this.parent.dataSeries[0].axisX.convertPixelToValue({y:this.parent.sessionVariables.crosshairShownByPixel?this.chart.sessionVariables.mouseY:g});else if("left"===this.parent._position||"right"===this.parent._position)s=this.parent.convertPixelToValue({y:g});for(var t=0;t<this.parent.dataSeries.length;t++)(v=this.parent.dataSeries[t].getDataPointAtX(s,
!0,!0))&&0<=v.index&&(v.dataSeries=this.parent.dataSeries[t],null!==v.dataPoint.y&&v.dataSeries.visible&&p.push(v));v=null;if(0===p.length)return;p.sort(function(a,b){return a.distance-b.distance});var x=v=0;yPercent=cumulativeY=0;for(var s=Infinity,w,t=0;t<p.length;t++){if("rangeBar"===p[t].dataSeries.type||"error"===p[t].dataSeries.type){if(p[t].dataPoint.y)for(var z=0;z<p[t].dataPoint.y.length;z++)x=Math.abs(a-this.parent.convertValueToPixel(p[t].dataPoint.y[z])),x<=s&&(s=x,v=t)}else"stackedBar"===
p[t].dataSeries.type?(cumulativeY=p[t].dataSeries.dataPointEOs[p[t].index].cumulativeY,x=Math.abs(a-this.parent.convertValueToPixel(cumulativeY)),x<=s&&(s=x,v=t)):"stackedBar100"===p[t].dataSeries.type?(x=p[0].dataPoint.x.getTime?p[0].dataPoint.x.getTime():p[0].dataPoint.x,m(w)&&(w=Math.abs(a-this.parent.convertValueToPixel(100*(p[0].dataSeries.dataPointEOs[p[0].index].cumulativeY/p[0].dataSeries.plotUnit.dataPointYSums[x])))),cumulativeY=p[t].dataSeries.dataPointEOs[p[t].index].cumulativeY,x=p[t].dataPoint.x.getTime?
p[t].dataPoint.x.getTime():p[t].dataPoint.x,yPercent=100*(cumulativeY/p[t].dataSeries.plotUnit.dataPointYSums[x]),x=Math.abs(a-this.parent.convertValueToPixel(yPercent)),x<=w&&(w=x,v=t)):(x=Math.abs(a-this.parent.convertValueToPixel(p[t].dataPoint.y)),x<=s&&(s=x,v=t));m(w)||(s=Math.min(s,w))}w=p[v];t=0;if("bottom"===this.parent._position||"top"===this.parent._position){if("rangeBar"===w.dataSeries.type||"error"===w.dataSeries.type){s=Math.abs(a-this.parent.convertValueToPixel(w.dataPoint.y[0]));for(p=
0;p<w.dataPoint.y.length;p++)x=Math.abs(a-this.parent.convertValueToPixel(w.dataPoint.y[p])),x<s&&(s=x,t=p);k=1===f.lineWidth%2?(this.parent.convertValueToPixel(w.dataPoint.y[t])<<0)+0.5:this.parent.convertValueToPixel(w.dataPoint.y[t])<<0;this.value=w.dataPoint.y[t];0!==w.dataPoint.y[t]%1&&m(this.options.valueFormatString)&&(this.valueFormatString=y.generateValueFormatString(this.parent.range,Math.floor(Math.abs(Math.log(this.parent.range)/Math.LN10))+(5>this.parent.range?2:10>this.parent.range?
1:0)));n.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:w.dataPoint.y[t]}):m(this.options.label)?ha(w.dataPoint.y[t],this.valueFormatString,this.chart._cultureInfo):this.label}else"stackedBar"===w.dataSeries.type?(s=Math.abs(a-this.parent.convertValueToPixel(p[0].dataPoint.y)),cumulativeY=w.dataSeries.dataPointEOs[w.index].cumulativeY,k=1===f.lineWidth%2?(this.parent.convertValueToPixel(cumulativeY)<<0)+0.5:this.parent.convertValueToPixel(cumulativeY)<<
0,this.value=cumulativeY,0!==cumulativeY%1&&m(this.options.valueFormatString)&&(this.valueFormatString=y.generateValueFormatString(this.parent.range,Math.floor(Math.abs(Math.log(this.parent.range)/Math.LN10))+(5>this.parent.range?2:10>this.parent.range?1:0))),n.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:cumulativeY}):m(this.options.label)?ha(cumulativeY,this.valueFormatString,this.chart._cultureInfo):this.label):"stackedBar100"===
w.dataSeries.type?(s=Math.abs(a-this.parent.convertValueToPixel(p[0].dataPoint.y)),cumulativeY=w.dataSeries.dataPointEOs[w.index].cumulativeY,x=w.dataPoint.x.getTime?w.dataPoint.x.getTime():w.dataPoint.x,yPercent=100*(cumulativeY/w.dataSeries.plotUnit.dataPointYSums[x]),k=1===f.lineWidth%2?(this.parent.convertValueToPixel(yPercent)<<0)+0.5:this.parent.convertValueToPixel(yPercent)<<0,this.value=yPercent,0!==yPercent%1&&m(this.options.valueFormatString)&&(this.valueFormatString=y.generateValueFormatString(this.parent.range,
Math.floor(Math.abs(Math.log(this.parent.range)/Math.LN10))+(5>this.parent.range?2:10>this.parent.range?1:0))),n.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:yPercent}):m(this.options.label)?ha(yPercent,this.valueFormatString,this.chart._cultureInfo):this.label):(k=1===f.lineWidth%2?(this.parent.convertValueToPixel(w.dataPoint.y)<<0)+0.5:this.parent.convertValueToPixel(w.dataPoint.y)<<0,this.value=w.dataPoint.y,0!==w.dataPoint.y%
1&&m(this.options.valueFormatString)&&(this.valueFormatString=y.generateValueFormatString(this.parent.range,Math.floor(Math.abs(Math.log(this.parent.range)/Math.LN10))+(5>this.parent.range?2:10>this.parent.range?1:0))),n.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:w.dataPoint.y}):m(this.options.label)?ha(w.dataPoint.y,this.valueFormatString,this.chart._cultureInfo):this.label);b=e=k;d=this.chart.plotArea.y1;l=this.chart.plotArea.y2;
this.bounds={x1:b-r/2,y1:d,x2:e+r/2,y2:l};n.x=b-n.measureText().width/2;n.x+n.width>this.chart.bounds.x2?n.x=this.chart.bounds.x2-n.width:n.x<this.chart.bounds.x1&&(n.x=this.chart.bounds.x1);n.y=this.parent.lineCoordinates.y2+("top"===this.parent._position?-n.height+this.parent.tickLength:n.fontSize/2)+2;n.y+n.height>this.chart.bounds.y2?n.y=this.chart.bounds.y2-n.height:n.y<this.chart.bounds.y1&&(n.y=this.chart.bounds.y1)}else if("left"===this.parent._position||"right"===this.parent._position){d=
l=h=1===f.lineWidth%2?(this.parent.convertValueToPixel(w.dataPoint.x)<<0)+0.5:this.parent.convertValueToPixel(w.dataPoint.x)<<0;b=this.chart.plotArea.x1;e=this.chart.plotArea.x2;this.bounds={x1:b,y1:d-r/2,x2:e,y2:l+r/2};t=!1;if(this.parent.labels)for(s=Math.ceil(this.parent.interval),p=0;p<this.parent.viewportMaximum;p+=s)if(this.parent.labels[p])t=!0;else{t=!1;break}if(t){if("axisX"===this.parent.type)for(s=this.parent.convertPixelToValue({y:g}),v=null,t=0;t<this.parent.dataSeries.length;t++)(v=
this.parent.dataSeries[t].getDataPointAtX(s,!0,!0))&&0<=v.index&&(n.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:w.dataPoint.x}):m(this.options.label)?v.dataPoint.label:this.label)}else"dateTime"!==this.parent.valueType||this.parent.logarithmic?(0!==w.dataPoint.x%1&&m(this.options.valueFormatString)&&(this.valueFormatString=y.generateValueFormatString(this.parent.range,Math.floor(Math.abs(Math.log(this.parent.range)/Math.LN10))+
...
this.label;this.value=w.dataPoint.x;n.y=l+n.fontSize/2-n.measureText().height/2+2;n.y-n.fontSize/2<this.chart.bounds.y1?n.y=this.chart.bounds.y1+n.fontSize/2+2:n.y+n.measureText().height-n.fontSize/2>this.chart.bounds.y2&&(n.y=this.chart.bounds.y2-n.measureText().height+n.fontSize/2);"left"===this.parent._position?n.x=this.parent.lineCoordinates.x2-n.measureText().width:"right"===this.parent._position&&(n.x=this.parent.lineCoordinates.x2)}}else if("bottom"===this.parent._position||"top"===this.parent._position){s=
this.parent.convertPixelToValue({x:a});for(t=0;t<this.parent.dataSeries.length;t++)(v=this.parent.dataSeries[t].getDataPointAtX(s,!0,!0))&&0<=v.index&&(v.dataSeries=this.parent.dataSeries[t],null!==v.dataPoint.y&&v.dataSeries.visible&&p.push(v));if(0===p.length)return;p.sort(function(a,b){return a.distance-b.distance});w=p[0];b=e=k=1===f.lineWidth%2?(this.parent.convertValueToPixel(w.dataPoint.x)<<0)+0.5:this.parent.convertValueToPixel(w.dataPoint.x)<<0;d=this.chart.plotArea.y1;l=this.chart.plotArea.y2;
this.bounds={x1:b-r/2,y1:d,x2:e+r/2,y2:l};t=!1;if(this.parent.labels)for(s=Math.ceil(this.parent.interval),p=0;p<this.parent.viewportMaximum;p+=s)if(this.parent.labels[p])t=!0;else{t=!1;break}if(t){if("axisX"===this.parent.type)for(s=this.parent.convertPixelToValue({x:a}),v=null,t=0;t<this.parent.dataSeries.length;t++)(v=this.parent.dataSeries[t].getDataPointAtX(s,!0,!0))&&0<=v.index&&(n.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,
value:w.dataPoint.x}):m(this.options.label)?v.dataPoint.label:this.label)}else"dateTime"!==this.parent.valueType||this.parent.logarithmic?(0!==w%1&&m(this.options.valueFormatString)&&(this.valueFormatString=y.generateValueFormatString(this.parent.range,Math.floor(Math.abs(Math.log(this.parent.range)/Math.LN10))+(5>this.parent.range?2:10>this.parent.range?1:0))),n.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:w.dataPoint.x}):m(this.options.label)?
ha(w.dataPoint.x,this.valueFormatString,this.chart._cultureInfo):this.label):n.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:w.dataPoint.x}):m(this.options.label)?Ea(w.dataPoint.x,this.valueFormatString,this.chart._cultureInfo):this.label;this.value=w.dataPoint.x;n.x=b-n.measureText().width/2;n.x+n.width>this.chart.bounds.x2&&(n.x=this.chart.bounds.x2-n.width);n.x<this.chart.bounds.x1&&(n.x=this.chart.bounds.x1);"bottom"===this.parent._position?
n.y=this.parent.lineCoordinates.y2+n.fontSize/2+2:"top"===this.parent._position&&(n.y=this.parent.lineCoordinates.y1-n.height+n.fontSize/2+2)}else if("left"===this.parent._position||"right"===this.parent._position){!m(this.parent.dataSeries)&&0<this.parent.dataSeries.length&&(s=this.parent.dataSeries[0].axisX.convertPixelToValue({x:this.parent.sessionVariables.crosshairShownByPixel?this.chart.sessionVariables.mouseX:a}));for(t=0;t<this.parent.dataSeries.length;t++)(v=this.parent.dataSeries[t].getDataPointAtX(s,
!0,!0))&&0<=v.index&&(v.dataSeries=this.parent.dataSeries[t],null!==v.dataPoint.y&&v.dataSeries.visible&&p.push(v));if(0===p.length)return;p.sort(function(a,b){return a.distance-b.distance});x=v=0;s=Infinity;for(t=0;t<p.length;t++){if("rangeColumn"===p[t].dataSeries.type||"rangeArea"===p[t].dataSeries.type||"error"===p[t].dataSeries.type||"rangeSplineArea"===p[t].dataSeries.type||"candlestick"===p[t].dataSeries.type||"ohlc"===p[t].dataSeries.type||"boxAndWhisker"===p[t].dataSeries.type){if(p[t].dataPoint.y)for(z=
0;z<p[t].dataPoint.y.length;z++)x=Math.abs(g-this.parent.convertValueToPixel(p[t].dataPoint.y[z])),x<=s&&(s=x,v=t)}else"stackedColumn"===p[t].dataSeries.type?(a=p[t].dataSeries.dataPointEOs[p[t].index].cumulativeY,x=Math.abs(g-this.parent.convertValueToPixel(a)),x<=s&&(s=x,v=t)):"stackedArea"===p[t].dataSeries.type?(a=p[t].dataSeries.dataPointEOs[p[t].index].cumulativeY,x=Math.abs(g-this.parent.convertValueToPixel(a)),x<=s&&(s=x,v=t)):"stackedColumn100"===p[t].dataSeries.type||"stackedArea100"===
p[t].dataSeries.type?(x=p[0].dataPoint.x.getTime?p[0].dataPoint.x.getTime():p[0].dataPoint.x,m(w)&&(w=Math.abs(g-this.parent.convertValueToPixel(100*(p[0].dataSeries.dataPointEOs[p[0].index].cumulativeY/p[0].dataSeries.plotUnit.dataPointYSums[x])))),"stackedColumn100"===p[t].dataSeries.type?(h=p[t].dataSeries.dataPointEOs[p[t].index].cumulativeY,x=p[t].dataPoint.x.getTime?p[t].dataPoint.x.getTime():p[t].dataPoint.x,a=100*(h/p[t].dataSeries.plotUnit.dataPointYSums[x]),x=Math.abs(g-this.parent.convertValueToPixel(a)),
x<=w&&(w=x,v=t)):"stackedArea100"===p[t].dataSeries.type&&(h=p[t].dataSeries.dataPointEOs[p[t].index].cumulativeY,x=p[t].dataPoint.x.getTime?p[t].dataPoint.x.getTime():p[t].dataPoint.x,a=100*(h/p[t].dataSeries.plotUnit.dataPointYSums[x]),x=Math.abs(g-this.parent.convertValueToPixel(a)),x<=w&&(w=x,v=t))):"waterfall"===p[t].dataSeries.type?(x=Math.abs(g-this.parent.convertValueToPixel(p[t].dataSeries.dataPointEOs[p[t].index].cumulativeSum)),x<=s&&(w=s=x,v=t)):(x=Math.abs(g-this.parent.convertValueToPixel(p[t].dataPoint.y)),
x<=s&&(s=x,v=t));m(w)||(s=Math.min(s,w))}w=p[v];t=0;if("rangeColumn"===w.dataSeries.type||"rangeArea"===w.dataSeries.type||"error"===w.dataSeries.type||"rangeSplineArea"===w.dataSeries.type||"candlestick"===w.dataSeries.type||"ohlc"===w.dataSeries.type||"boxAndWhisker"===w.dataSeries.type){s=Math.abs(g-this.parent.convertValueToPixel(w.dataPoint.y[0]));for(p=0;p<w.dataPoint.y.length;p++)x=Math.abs(g-this.parent.convertValueToPixel(w.dataPoint.y[p])),x<s&&(s=x,t=p);h=1===f.lineWidth%2?(this.parent.convertValueToPixel(w.dataPoint.y[t])<<
0)+0.5:this.parent.convertValueToPixel(w.dataPoint.y[t])<<0;0!==w.dataPoint.y[t]%1&&m(this.options.valueFormatString)&&(this.valueFormatString=y.generateValueFormatString(this.parent.range,Math.floor(Math.abs(Math.log(this.parent.range)/Math.LN10))+(5>this.parent.range?2:10>this.parent.range?1:0)));n.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:w.dataPoint.y[t]}):m(this.options.label)?ha(w.dataPoint.y[t],this.valueFormatString,
...
this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:a}):m(this.options.label)?ha(a,this.valueFormatString,this.chart._cultureInfo):this.label,this.value=a):"stackedArea"===w.dataSeries.type?(a=w.dataSeries.dataPointEOs[w.index].cumulativeY,h=1===f.lineWidth%2?(this.parent.convertValueToPixel(a)<<0)+0.5:this.parent.convertValueToPixel(a)<<0,0!==a%1&&m(this.options.valueFormatString)&&(this.valueFormatString=y.generateValueFormatString(this.parent.range,Math.floor(Math.abs(Math.log(this.parent.range)/
Math.LN10))+(5>this.parent.range?2:10>this.parent.range?1:0))),n.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:a}):m(this.options.label)?ha(a,this.valueFormatString,this.chart._cultureInfo):this.label,this.value=a):"stackedColumn100"===w.dataSeries.type?(h=w.dataSeries.dataPointEOs[w.index].cumulativeY,x=w.dataPoint.x.getTime?w.dataPoint.x.getTime():w.dataPoint.x,a=100*(h/w.dataSeries.plotUnit.dataPointYSums[x]),h=1===f.lineWidth%
2?(this.parent.convertValueToPixel(a)<<0)+0.5:this.parent.convertValueToPixel(a)<<0,0!==a%1&&m(this.options.valueFormatString)&&(this.valueFormatString=y.generateValueFormatString(this.parent.range,Math.floor(Math.abs(Math.log(this.parent.range)/Math.LN10))+(5>this.parent.range?2:10>this.parent.range?1:0))),n.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:a}):m(this.options.label)?ha(a,this.valueFormatString,this.chart._cultureInfo):
...
this.parent.range?2:10>this.parent.range?1:0))),n.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:a}):m(this.options.label)?ha(a,this.valueFormatString,this.chart._cultureInfo):this.label,this.value=a):"waterfall"===w.dataSeries.type?(h=1===f.lineWidth%2?(this.parent.convertValueToPixel(w.dataSeries.dataPointEOs[w.index].cumulativeSum)<<0)+0.5:this.parent.convertValueToPixel(w.dataSeries.dataPointEOs[w.index].cumulativeSum)<<0,0!==
w.dataSeries.dataPointEOs[w.index].cumulativeSum%1&&m(this.options.valueFormatString)&&(this.valueFormatString=y.generateValueFormatString(this.parent.range,Math.floor(Math.abs(Math.log(this.parent.range)/Math.LN10))+(5>this.parent.range?2:10>this.parent.range?1:0))),n.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:w.dataSeries.dataPointEOs[w.index].cumulativeSum}):m(this.options.label)?ha(w.dataSeries.dataPointEOs[w.index].cumulativeSum,
...
c.moveTo(a+e/2,g-e/2),c.lineTo(a-e/2,g+e/2),c.stroke())}},drawMarkers:function(a){for(var g=0;g<a.length;g++){var c=a[g];X.drawMarker(c.x,c.y,c.ctx,c.type,c.size,c.color,c.borderColor,c.borderThickness)}}};return v}();s.version="v3.14.4 GA";window.CanvasJS&&(s&&!window.CanvasJS.Chart)&&(window.CanvasJS.Chart=s)})();
